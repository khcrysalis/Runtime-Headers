...
- (BOOL)br_isTableExists:(id)a0;
- (void)br_makeNextFlushCheckpoint;
- (id)dataWithSQL:(id)a0;
- (id)itemIDWithSQL:(id)a0;
- (id)numberWithSQL:(id)a0;
- (BOOL)registerFunction:(id)a0 nArgs:(int)a1 handler:(id /* block */)a2 error:(id *)a3;
- (id)stringWithSQL:(id)a0;
- (void)dealloc;
- (id)description;
- (id)init;
- (void).cxx_destruct;
...
- (BOOL)_executeStmt:(id)a0 mustSucceed:(BOOL)a1 preparationTime:(unsigned long long)a2;
...
- (id)_newStatementForFormat:(id)a0 preparationTime:(unsigned long long *)a1 arguments:(char *)a2;

@class NSUUID, NSString, SMSessionConfiguration, NSData, CLLocation, NSDate, SMSessionMonitorContext;

@interface SMSessionManagerState : NSObject <RTCoreDataReadable, RTCoreDataWritable, NSMutableCopying, NSCopying, NSSecureCoding>
...
+ (id)createWithSMSessionManagerStateMO:(id)a0;

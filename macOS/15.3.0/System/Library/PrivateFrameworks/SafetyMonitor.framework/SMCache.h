@class NSUUID, NSString, NSData, NSArray, NSSet, GEOLocationShifter, SMLocation, SMDeviceStatus;

@interface SMCache : NSObject <RTCoreDataReadable, RTCoreDataWritable, NSSecureCoding, NSCopying> {
...
+ (id)_getOrCreateManagedLocationsFromLocations:(id)a0;
+ (id)createWithManagedObject:(id)a0;
+ (id)createWithSMCacheMO:(id)a0;

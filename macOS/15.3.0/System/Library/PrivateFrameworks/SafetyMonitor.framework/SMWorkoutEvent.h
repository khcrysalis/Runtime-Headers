@class NSString, NSUUID, NSDate, SMLocation;

@interface SMWorkoutEvent : NSObject <RTCoreDataReadable, RTCoreDataWritable, NSSecureCoding, NSCopying>
...
+ (id)createWithSMWorkoutEventMO:(id)a0;
+ (id)createWithSMWorkoutEventMOs:(id)a0;

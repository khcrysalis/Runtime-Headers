@class NSURL, NSString, NSDictionary, NSPersonNameComponents, NSData, NSObject, NSNumber;
...
@property (readonly, nonatomic) BOOL isSavedConflictResolved;
...
- (BOOL)_br_markResolvedWithError:(id *)a0;
- (BOOL)br_markResolvedWithError:(id *)a0;
- (BOOL)fp_markResolvedWithError:(id *)a0;
...
- (BOOL)markSavedConflictAsResolved:(BOOL)a0 error:(id *)a1;

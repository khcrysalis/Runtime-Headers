...
+ (id)overlayWithDrawable:(id)a0 forOverlay:(id)a1 atLevel:(long long)a2;
...
- (void)drawKey:(const struct { unsigned int x0; unsigned int x1; unsigned int x2; unsigned int x3; } *)a0 withData:(id)a1 inIOSurface:(struct __IOSurface { } *)a2 withTimestamp:(double)a3 withTileScale:(float)a4;

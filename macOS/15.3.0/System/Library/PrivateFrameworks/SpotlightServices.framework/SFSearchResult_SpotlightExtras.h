@class NSDate, NSString, NSArray, NSURL, SFImage, PRSRankingItem, NSMutableDictionary, LSApplicationProxy, NSImage, NSData, IQFMapsPersonalizationResult, NSNumber;
...
- (void)setLastRestrictionStatus:(BOOL)a0;
- (void)setMatchName:(id)a0;
- (void)setNeedsPreviewUpdate:(BOOL)a0;
- (BOOL)shouldNotBeTopHit;
- (id)subjectForEmailAttachment;
- (id)title_note;
- (id)unknownImage;
- (BOOL)useFinderIconAsPrefPaneImageForBundle:(id)a0;

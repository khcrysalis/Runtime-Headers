...
@property (readonly, nonatomic) id /* block */ hksp_boolErrorCompletionHandlerAdapter;
...
+ (id)hksp_expiringFutureWithTimeout:(double)a0;
+ (id)_hksp_chainFutureHelperWithFutures:(id)a0 index:(unsigned long long)a1 block:(id /* block */)a2 ignoreErrors:(BOOL)a3;
+ (id)hksp_chainFutures:(id)a0 returningFirstPassingTest:(id /* block */)a1;
+ (id)hksp_chainFutures:(id)a0 returningFirstPassingTest:(id /* block */)a1 ignoreErrors:(BOOL)a2;

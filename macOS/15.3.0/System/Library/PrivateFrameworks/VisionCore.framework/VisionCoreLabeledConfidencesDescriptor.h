...
- (id)newClassificationObservationsFromOutputObjects:(id)a0 originatingRequestSpecifier:(id)a1 operationPointsProvider:(id)a2 error:(id *)a3;
- (id)newClassificationObservationsFromTensorData:(id)a0 originatingRequestSpecifier:(id)a1 operationPointsProvider:(id)a2 error:(id *)a3;
- (id)description;

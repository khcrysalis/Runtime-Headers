...
- (id)VNFaceprintFromOutputObjects:(id)a0 originatingRequestSpecifier:(id)a1 error:(id *)a2;
- (id)VNFaceprintFromData:(id)a0 confidence:(float)a1 originatingRequestSpecifier:(id)a2 error:(id *)a3;
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;

@class VisionCoreSceneNetInferenceNetworkCustomClassifierDescriptor, NSString, VisionCoreTensorDescriptor, NSURL, VNDisallowedList;
...
- (id)VNSceneprintFromData:(id)a0 labelsAndConfidences:(id)a1 originatingRequestSpecifier:(id)a2 error:(id *)a3;
- (id)VNSceneprintFromData:(id)a0 originatingRequestSpecifier:(id)a1 error:(id *)a2;
- (id)VNSceneprintFromOutputObjects:(id)a0 originatingRequestSpecifier:(id)a1 error:(id *)a2;

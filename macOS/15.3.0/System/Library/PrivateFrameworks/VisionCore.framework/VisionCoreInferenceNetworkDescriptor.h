...
- (id)VNEspressoModelImageprintOfClass:(Class)a0 fromData:(id)a1 tensorDescriptor:(id)a2 originatingRequestSpecifier:(id)a3 fromBlock:(id /* block */)a4 error:(id *)a5;
- (BOOL)getVNEspressoModelImageprintData:(id *)a0 elementType:(unsigned long long *)a1 elementCount:(unsigned long long *)a2 fromTensorData:(id)a3 descriptor:(id)a4 error:(id *)a5;
- (id)description;

...
- (struct CGImage { } *)NS_hierarchicalOrPaletteCGImageWithPixelSize:(struct CGSize { double x0; double x1; })a0 colors:(id)a1 renderingStyle:(long long)a2;
- (struct CGImage { } *)NS_monochromeCGImageWithPixelSize:(struct CGSize { double x0; double x1; })a0;
- (struct CGImage { } *)NS_multicolorCGImageWithPixelSize:(struct CGSize { double x0; double x1; })a0 namedColorOverrides:(id)a1;
- (BOOL)NS_needsHorizontalFlipForRequestedLayoutDirection:(long long)a0;
- (void)dealloc;

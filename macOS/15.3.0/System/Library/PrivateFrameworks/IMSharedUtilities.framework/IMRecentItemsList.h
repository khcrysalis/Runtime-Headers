...
- (void)loadRecentHandwritingsAndStickersWithThumbnailSize:(struct CGSize { double x0; double x1; })a0 completion:(id /* block */)a1;
- (void)loadRecentHandwritingsWithThumbnailSize:(struct CGSize { double x0; double x1; })a0 completion:(id /* block */)a1;
- (void)loadRecentStickers:(id /* block */)a0;
- (void)dealloc;
- (id)init;

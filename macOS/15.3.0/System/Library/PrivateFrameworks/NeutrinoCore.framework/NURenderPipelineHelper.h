...
- (id)debugNodeByApplyingFilterWithName:(id)a0 useHDRFilter:(BOOL)a1 settingsAndInputs:(id)a2;
- (id)nodeByApplyingFilterWithName:(id)a0 useHDRFilter:(BOOL)a1 settingsAndInputs:(id)a2;
- (id)performApertureRedeyeOnImage:(id)a0 useHDRFilter:(BOOL)a1 redEyeAdjustment:(id)a2;
- (id)performLongExposureFusionForComposition:(id)a0 longExposureImage:(id)a1 useHDRFilter:(BOOL)a2 error:(out id *)a3;
- (id)performRedeyeOnImage:(id)a0 useHDRFilter:(BOOL)a1 redEyeAdjustment:(id)a2;
- (id)portraitVideo:(id)a0 disparityInput:(id)a1 disparityKeyframes:(id)a2 apertureKeyframes:(id)a3 debugMode:(long long)a4 error:(out id *)a5;
- (id)portraitVideoDebugDetectedObjects:(id)a0 source:(id)a1 cinematographyState:(id)a2 monochrome:(BOOL)a3 error:(out id *)a4;
- (id)remapPortraitV2Strength:(id)a0 portraitEffectKind:(id)a1;
- (long long)versionForPortraitEffect:(id)a0;
- (id)videoCrossfadeLoop:(id)a0 crossfadeAdjustment:(id)a1 error:(out id *)a2;
- (id)videoReframe:(id)a0 reframes:(id)a1 error:(out id *)a2;
- (void).cxx_destruct;

...
+ (id)mad_audioTaxonomy:(BOOL)a0 useResultsKey:(BOOL)a1;
+ (BOOL)mad_isExpectedTaxonomy;
+ (id)vcp_sharedTaxonomy;
+ (id)sharedTaxonomy;

- (id)mad_allAncestorsForSceneId:(unsigned int)a0;
- (id)mad_extendedSceneIdFromSceneName:(id)a0;
- (id)mad_sceneNameFromExtendedSceneId:(unsigned long long)a0;
- (id)init;
- (void).cxx_destruct;
- (id).cxx_construct;

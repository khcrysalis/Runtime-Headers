@class GEODirectionsRequestFeedback, GEOOriginalRoute, GEOMapRegion, GEORecentLocationHistory, GEOClientCapabilities, GEOPrivacyMetadata, GEOLocation, PBUnknownFields, NSMutableArray, GEOTripInfo, GEOPDABClientDatasetMetadata, NSString, GEOClientFeedbackInfo, PBDataReader, GEOCommonOptions, NSData, GEORouteAttributes, GEOAdditionalEnabledMarkets, GEOOriginalWaypointRoute;
...
@interface GEODirectionsRequest : PBRequest <NSCopying> {
    ...
    BOOL _isFromAPI;
    struct { unsigned char has_sessionID : 1; unsigned char has_requestTime : 1; unsigned char has_sessionRelativeTimestamp : 1; unsigned char has_departureTime : 1; unsigned char has_lastEtaDisplayed : 1; unsigned char has_mainTransportTypeMaxRouteCount : 1; unsigned char has_nonRecommendedRoutesOption : 1; unsigned char has_originalRoutePurpose : 1; unsigned char has_sequenceNumber : 1; unsigned char has_timeSinceLastRerouteRequest : 1; unsigned char has_trafficSnapshotUnixTime : 1; unsigned char has_getRouteForZilchPoints : 1; unsigned char has_isFromAPI : 1; unsigned char read_unknownFields : 1; unsigned char read_abClientMetadata : 1; unsigned char read_additionalEnabledMarkets : 1; unsigned char read_clientCapabilities : 1; unsigned char read_clientFeedbackInfo : 1; unsigned char read_commonOptions : 1; unsigned char read_currentMapRegion : 1; unsigned char read_currentUserLocation : 1; unsigned char read_deviceHistoricalLocations : 1; unsigned char read_displayedBannerIds : 1; unsigned char read_feedback : 1; unsigned char read_lastKnownRoadLocation : 1; unsigned char read_loggedAbExperiment : 1; unsigned char read_nonRecommendedRoutesCache : 1; unsigned char read_originalDirectionsResponseID : 1; unsigned char read_originalRouteID : 1; unsigned char read_originalRouteZilchPoints : 1; unsigned char read_originalRoute : 1; unsigned char read_originalRouteEvInfos : 1; unsigned char read_originalWaypointRoute : 1; unsigned char read_privacyMetadata : 1; unsigned char read_recentLocationHistory : 1; unsigned char read_routeAttributes : 1; unsigned char read_serviceTags : 1; unsigned char read_sessionState : 1; unsigned char read_trafficApiResponses : 1; unsigned char read_trafficSnapshotIds : 1; unsigned char read_tripInfo : 1; unsigned char read_waypointTypeds : 1; unsigned char wrote_anyField : 1; } _flags;
}
...
@property (nonatomic) BOOL hasTrafficSnapshotUnixTime;
...
- (void)_commonSetup:(id)a0;
- (id)initWithDirectionsRequest:(id)a0 origin:(id)a1 destination:(id)a2 withFeedback:(id)a3;

...
- (void)addFakeTrafficIncidentAlert:(unsigned long long)a0 targetLegIndex:(unsigned long long)a1 mainRouteInfo:(id)a2 alternateRouteInfo:(id)a3 currentDistance:(unsigned int)a4;
- (void)dealloc;

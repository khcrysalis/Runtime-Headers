...
- (id)fillRulesForPlateTypes:(id)a0 atIndexes:(id)a1;
- (BOOL)hasValidDateInterval;
- (id)mapRulesForPlateTypes:(id)a0 atIndexes:(id)a1;
- (id)pickupRulesForPlateTypes:(id)a0 atIndexes:(id)a1;
- (id)rules:(id)a0 forPlateTypes:(id)a1 atIndexes:(id)a2;

...
+ (id)styleAttributesForCalloutWithAttributes:(id)a0;
+ (id)styleAttributesForDraggingWithAttributes:(id)a0;
+ (id)styleAttributesForMapFeatureAttributes:(id)a0 elevatedGround:(BOOL)a1;
+ (id)styleAttributesForRouteAnnotationWithAttributes:(id)a0;
+ (id)styleAttributesForSearchResultWithAttributes:(id)a0;
+ (id)styleAttributesForTrafficCameraType:(long long)a0 isAboveThreshold:(BOOL)a1;
+ (id)styleAttributesForTrafficIncidentType:(long long)a0;
+ (id)styleAttributesForTransitType:(long long)a0;
+ (id)styleAttributesForUnpickedFeatureWithAttributes:(id)a0;
...
- (id)styleAttributesWithElevatedGround:(BOOL)a0;

...
+ (void)composedWaypointForMapItem:(id)a0 useAsLocation:(BOOL)a1 forQuickETA:(BOOL)a2 traits:(id)a3 completionHandler:(id /* block */)a4 networkActivityHandler:(id /* block */)a5;
...
- (id)navAnnouncementAddressAndSubstituteType:(int *)a0;
- (id)navAnnouncementName;
- (id)navAnnouncementNameAndSubstituteType:(int *)a0;
- (id)navDisplayAddress;
- (id)navDisplayAddressAndSubstituteType:(int *)a0;
- (id)navDisplayName;
- (id)navDisplayNameAndSubstituteType:(int *)a0;
- (id)navDisplayNameWithSpecialContacts:(BOOL)a0;
- (id)navDisplayNameWithSpecialContacts:(BOOL)a0 substituteType:(int *)a1;

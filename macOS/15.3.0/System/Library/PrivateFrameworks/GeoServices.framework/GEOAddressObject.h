...
- (id)initWithCurrentLocaleFullThoroughfare:(id)a0 subLocality:(id)a1 locality:(id)a2 subAdministrativeArea:(id)a3 administrativeArea:(id)a4 postalCode:(id)a5 country:(id)a6 countryCode:(id)a7;
- (id)initWithFullThoroughfare:(id)a0 subLocality:(id)a1 locality:(id)a2 subAdministrativeArea:(id)a3 administrativeArea:(id)a4 postalCode:(id)a5 country:(id)a6 countryCode:(id)a7 language:(id)a8 countryLocale:(id)a9 phoneticLocale:(id)a10;
- (void)dealloc;

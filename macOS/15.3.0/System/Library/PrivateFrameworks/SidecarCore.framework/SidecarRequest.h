...
- (id)observerWithCondition:(id)a0;
- (void)performRunModalWithResponder:(id)a0 inMode:(id)a1;
- (long long)runModalWithResponder:(id)a0;
- (void)dealloc;
- (void).cxx_destruct;
- (id)data;
- (id)error;
...
- (void)listenForStreamType:(long long)a0 flags:(unsigned long long)a1 identifier:(id)a2;
...
- (void)openStreamForType:(long long)a0 flags:(unsigned long long)a1 identifier:(id)a2;

...
+ (id)locationsOfInterestFromLearnedLocationsOfInterest:(id)a0;
+ (long long)routineModeFromLearnedLocationMode:(long long)a0;
+ (long long)typeFromPlaceType:(unsigned long long)a0;
+ (unsigned long long)typeSourceFromPlaceTypeSource:(unsigned long long)a0;
...
- (id)initWithLearnedLocationOfInterest:(id)a0;
- (id)initWithOneState:(id)a0;

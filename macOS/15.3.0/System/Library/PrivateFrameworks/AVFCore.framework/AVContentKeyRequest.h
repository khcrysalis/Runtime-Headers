...
- (BOOL)_processContentKeyResponse:(id)a0 renewalDate:(id)a1 initializationVector:(id)a2 error:(id *)a3;
...
- (id)initWithContentKeySession:(id)a0 contentKeyBoss:(struct OpaqueFigContentKeyBoss { } *)a1 useContentKeyBoss:(BOOL)a2 keySpecifier:(struct OpaqueFigContentKeySpecifier { } *)a3 initializationData:(id)a4 keyIDFromInitializationData:(id)a5 contentIdentifier:(id)a6 isRenewalRequest:(BOOL)a7 requestID:(unsigned long long)a8 providesPersistableKey:(BOOL)a9 preloadingRequestOptions:(id)a10 identifier:(id)a11 supportsOfflineKey:(BOOL)a12;

@class NSArray, NSString, AVVideoCompositionInternal, AVVideoCompositionCoreAnimationTool;

@interface AVVideoComposition : NSObject <NSCopying, NSMutableCopying> {
    AVVideoCompositionInternal *_videoComposition;
}

@property (nonatomic, readonly) NSArray *_sourceSampleDataTrackIDs;
...
- (id)_trackWithTrackID:(int)a0 inTracks:(id)a1;
...
- (BOOL)isValidForTracks:(id)a0 assetDuration:(struct { long long x0; int x1; unsigned int x2; long long x3; })a1 timeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a2 validationDelegate:(id)a3;
...
- (void)setSourceSampleDataTrackWindowsForTrackIDs:(id)a0;
- (void)setSourceVideoTrackWindowsForTrackIDs:(id)a0;

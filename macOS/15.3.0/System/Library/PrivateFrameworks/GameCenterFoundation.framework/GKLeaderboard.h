...
@property (readonly, nonatomic) BOOL hasActiveChallenges;
@property (readonly, nonatomic) BOOL supportsChallenges;

+ (id)localizedStringForLeaderboardOccurrence:(long long)a0;
+ (id)localizedStringForTimeScope:(long long)a0;

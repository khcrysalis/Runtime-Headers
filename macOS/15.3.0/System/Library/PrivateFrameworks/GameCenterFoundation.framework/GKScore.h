...
+ (void)reportLeaderboardScores:(id)a0 withEligibleChallenges:(id)a1 withCompletionHandler:(id /* block */)a2;
+ (void)reportScores:(id)a0 withEligibleChallenges:(id)a1 withCompletionHandler:(id /* block */)a2;

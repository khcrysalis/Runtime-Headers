@class GKAchievementInternal, NSImage, NSString, NSNumber;
...
@property (readonly) unsigned long long releaseState;
...
- (void)loadImageWithTimeout:(double)a0 completionHandler:(id /* block */)a1;
- (id)description;

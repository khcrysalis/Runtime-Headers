...
+ (id)_constraintWithItem:(id)a0 attribute:(long long)a1 relatedBy:(long long)a2 toItem:(id)a3 attribute:(long long)a4 multiplier:(double)a5 constant:(double)a6 priority:(float)a7;
+ (id)_constraintsMatchingFrameOfView:(id)a0 withFrameOfView:(id)a1;
+ (id)_constraintsMatchingFrameOfView:(id)a0 withFrameOfView:(id)a1 edgeInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2;
+ (id)_constraintsMatchingFrameOfView:(id)a0 withFrameOfView:(id)a1 edgeInsets:(struct NSEdgeInsets { double x0; double x1; double x2; double x3; })a2 priority:(float)a3;
+ (id)_minimizingConstraintWithItem:(id)a0 attribute:(long long)a1;
+ (id)_ns_constraintWithItem:(id)a0 attribute:(long long)a1 relatedBy:(long long)a2 toItem:(id)a3 attribute:(long long)a4 multiplier:(double)a5 constant:(double)a6 layoutDirection:(long long)a7 priority:(float)a8 identifier:(id)a9;
+ (id)_ns_constraintsWithItem:(id)a0 attribute:(long long)a1 toItem:(id)a2 attribute:(long long)a3 constant:(double)a4 inequalityRelation:(long long)a5 inequalityIdentifier:(id)a6 inequalityPriority:(float)a7 equivalencePriority:(float)a8 equivalenceIdentifier:(id)a9 layoutDirection:(long long)a10;
+ (id)_ns_constraintsWithItem:(id)a0 attribute:(long long)a1 toItem:(id)a2 attribute:(long long)a3 inequalityRelation:(long long)a4 inequalityIdentifier:(id)a5 inequalityPriority:(float)a6 inequalityConstant:(double)a7 equivalencePriority:(float)a8 equivalenceIdentifier:(id)a9 equalityConstant:(double)a10 layoutDirection:(long long)a11;
...
- (long long)_geometricCompare:(id)a0;
- (BOOL)_isPrototypingConstraint;
- (int)_orientation;
- (void)_setConstant:(double)a0 animated:(BOOL)a1;
- (struct CGPoint { double x0; double x1; })_visualCenterInWindowSpace;

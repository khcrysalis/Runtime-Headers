@class MCMimePart, NSColor, ECSubject, MFMailbox, NSDate, NSDictionary, ECMessageFlags, NSMutableSet, MFMailAccount, NSString, EMFollowUp, ECAngleBracketIDHash, NSIndexSet, MCDisplayNameInfo, NSSet, NSArray, NSScriptObjectSpecifier, EMReadLater, NSData, NSUUID;

@class MRAVRoutingDiscoverySessionConfiguration, NSMutableDictionary, NSMapTable, NSArray, NSString, NSObject, NSMutableArray;
...
- (id)_replaceOutputDevices:(id)a0 withOutputDevices:(id)a1;
- (id)availableOutputDevicesForEndpoint:(id)a0;
- (void).cxx_destruct;

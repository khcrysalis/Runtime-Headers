...
- (void)_af_setNowPlayingInfo:(id)a0 mediaType:(long long)a1;
- (void)_af_setShuffleModeFromNowPlayingInfo:(id)a0;
- (void)_af_validateAndFinalize;
- (id)_mediaItemIdURLFromNowPlayingInfo:(id)a0;
- (id)_mediaTypeFromNowPlayingInfo:(id)a0;
- (id)groupIdentifier;
- (id)encodedClassName;

@class NSData, NSString, NSArray, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NTPBRecordBase, NTPBDate, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, NSMutableArray, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata;
...
- (id)generateFlintDocumentAssetHandleWithAssetManager:(id)a0;
- (id)generateThumbnailAssetHandleForURL:(id)a0 withAssetManager:(id)a1;
- (id)generateWebExcerptAssetHandleWithAssetManager:(id)a0;
- (BOOL)isAllowedInStorefront:(id)a0;
- (void)dealloc;

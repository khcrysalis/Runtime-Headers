...
- (id)generateExploreTileImageAssetHandleWithAssetManager:(id)a0;
...
- (id)generateNameImageMaskAssetHandleWithAssetManager:(id)a0;
- (id)generateNavigationChromeBackgroundDarkModeImageCompactHandleWithAssetManager:(id)a0;
- (id)generateNavigationChromeBackgroundDarkModeImageHandleWithAssetManager:(id)a0;
- (id)generateNavigationChromeBackgroundDarkModeImageLargeHandleWithAssetManager:(id)a0;
- (id)generateNavigationChromeBackgroundImageCompactHandleWithAssetManager:(id)a0;
- (id)generateNavigationChromeBackgroundImageHandleWithAssetManager:(id)a0;
- (id)generateNavigationChromeBackgroundImageLargeHandleWithAssetManager:(id)a0;
- (id)generateThumbnailImageAssetHandleForDate:(id)a0 difficulty:(id)a1 assetManager:(id)a2;
- (void)dealloc;

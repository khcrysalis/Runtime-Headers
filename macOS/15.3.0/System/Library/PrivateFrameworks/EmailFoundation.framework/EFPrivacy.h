...
+ (id)ec_redactedStringForMailboxURL:(id)a0;
+ (BOOL)_isWellKnownMailboxName:(id)a0;
+ (id)_redactedMailboxPathForMailboxPath:(id)a0;
+ (id)ec_partiallyRedactedStringForAddress:(id)a0;
+ (id)ec_partiallyRedactedStringForAddress:(id)a0 localPart:(id)a1 domain:(id)a2;
+ (id)ec_partiallyRedactedStringForSubjectOrSummary:(id)a0;

...
@interface CADEventCreatedFromSuggestionPredicate : EKPredicate <EKPredicateEvaluating>

@property (readonly, nonatomic) NSString *opaqueKey;
@property (readonly, nonatomic) NSString *extractionGroupIdentifier;
...
- (id)initWithExtractionGroupIdentifier:(id)a0;
- (id)initWithOpaqueKey:(id)a0;
...
- (id)initWithOpaqueKey:(id)a0 extractionGroupIdentifier:(id)a1;

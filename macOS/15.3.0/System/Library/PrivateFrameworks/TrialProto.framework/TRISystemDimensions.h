...
@interface TRISystemDimensions : PBCodable <NSCopying> {
    struct { unsigned char targetedPopulation : 1; unsigned char experimentOptOutStatus : 1; unsigned char isAutomatedTestDevice : 1; unsigned char isBetaUser : 1; unsigned char isInternalBuild : 1; } _has;
}

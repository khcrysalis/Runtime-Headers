@class UXView, NSArray, UXTabBarController, UXSourceController, UXNavigationItem, UXTabBarItem, UXWindowController, UXNavigationController, PXImageModulationManager, NSResponder;
...
@property (readonly, nonatomic) UXViewController *px_topmostPresentedViewController;
...
- (double)_px_imageModulationMixFactorWithPresentedViewController:(id)a0;
- (void)_px_viewAppearanceDidChange;
- (BOOL)_px_windowMatchesImageModulationManager:(id)a0;
- (void)_pxswizzled_imageModulation_prepareForTransitionWithContext:(id)a0 completion:(id /* block */)a1;
- (void)_pxswizzled_imageModulation_viewDidDisappear:(BOOL)a0;
- (void)_pxswizzled_imageModulation_viewWillAppear:(BOOL)a0;
- (void)_pxswizzled_imageModulation_viewWillDisappear:(BOOL)a0;

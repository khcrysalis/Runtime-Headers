...
- (void)_ppt_setTransitionAnimationCompletionHandler:(id /* block */)a0;
- (id /* block */)_ppt_transitionAnimationCompletionHandler;
- (void)ppt_installTransitionAnimationCompletionHandler:(id /* block */)a0;
...
- (void)px_pushViewController:(id)a0 animated:(BOOL)a1 completion:(id /* block */)a2;

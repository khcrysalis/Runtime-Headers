...
@interface WBSSavedAccountStore : NSObject <WBSSavedAccountStoreGroupSharingExtras, WBSSavedAccountStorePasskeyExtras, WBSSavedAccountStoreWebsiteNameConsumer, WBSOngoingSharingGroupProviderSubscriber, WBSAuthenticationServicesAgentDelegate> {
...
+ (id)_displayNameForOriginalContributorParticipantID:(id)a0 inGroupID:(id)a1;
...
- (void)_test_writeContentsOfAccountStoreToWriter:(id)a0;
- (void)_writeContentsOfAccounts:(id)a0 toWriter:(id)a1;
- (void)exportContentsOfAccountStoreToCSVFileWithPath:(id)a0;
- (void)exportContentsOfSavedAccounts:(id)a0 toCSVFileWithPath:(id)a1;
...
- (id)_moveCredentialTypesToRecentlyDeleted:(long long)a0 fromSavedAccount:(id)a1;
...
- (void)addAdditionalSite:(id)a0 toSavedAccount:(id)a1;
...
- (void)saveAdditionalSites:(id)a0 forSavedAccount:(id)a1;

...
- (void)requestIconForURLString:(id)a0 type:(long long)a1 item:(id)a2 useDefaultIconIfNoneAvailable:(BOOL)a3 tableView:(id)a4 column:(id)a5 row:(unsigned long long)a6 cellObjectType:(long long)a7 cellObject:(id)a8 completion:(id /* block */)a9;
- (void)dealloc;
- (void).cxx_destruct;

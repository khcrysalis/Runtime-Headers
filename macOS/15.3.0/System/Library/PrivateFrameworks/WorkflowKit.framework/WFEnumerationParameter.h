...
@interface WFEnumerationParameter : WFParameter <WFModuleSummarySupporting, WFParameterValuePickable, WFParameterDialogProvider>

@property (class, nonatomic, readonly) BOOL supportsEditingMultipleValues;

...
@interface WFAction : NSObject <NSItemProviderReading, NSItemProviderWriting, NSPasteboardReading, NSPasteboardWriting, WFAppInstalledResourceDelegate, WFUUIDProvider, WFParameterEventObserver, NSCopying, WFVariableProvider>
...
@property (readonly, nonatomic, getter=isApprovedForPublicShortcutsDrawer) BOOL approvedForPublicShortcutsDrawer;
...
@property (readonly, nonatomic) BOOL runningInToolKit;
...
@property (readonly, nonatomic) BOOL requiresPrivateOutputLogging;

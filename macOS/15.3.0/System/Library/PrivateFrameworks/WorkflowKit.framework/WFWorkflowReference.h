...
- (id)searchableItemRepresentationWithIconDrawerContext:(id)a0;
...
- (id)initWithIdentifier:(id)a0 name:(id)a1 color:(long long)a2 glyphCharacter:(unsigned short)a3 associatedAppBundleIdentifier:(id)a4 subtitle:(id)a5 actionsDescription:(id)a6 actionCount:(unsigned long long)a7 syncHash:(long long)a8 isDeleted:(BOOL)a9 hiddenFromLibraryAndSync:(BOOL)a10 creationDate:(id)a11 modificationDate:(id)a12 lastRunDate:(id)a13 remoteQuarantineStatus:(long long)a14 remoteQuarantineHash:(id)a15 hasShortcutInputVariables:(BOOL)a16 disabledOnLockScreen:(BOOL)a17 source:(id)a18 runEventsCount:(id)a19;

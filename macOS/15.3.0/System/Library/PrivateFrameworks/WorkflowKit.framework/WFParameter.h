...
- (id)clearButtonMenuItemWithVariable:(id)a0 parameterState:(id)a1 setVariableHandler:(id /* block */)a2;
- (BOOL)shouldShowVariable:(id)a0 allowedVariableTypes:(id)a1 variableProvider:(id)a2 variableUIDelegate:(id)a3;
- (id)variableMenuElementsWithVariable:(id)a0 parameterState:(id)a1 variableProvider:(id)a2 variableUIDelegate:(id)a3 setVariableHandler:(id /* block */)a4;
- (long long)arrayMaxCountForWidgetFamily:(long long)a0;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })arraySizeRangeForCHSWidgetFamily:(long long)a0;
- (void).cxx_destruct;

@class NSString, CRImageSpaceQuad, VKQuad;
...
- (double)boundingBoxClippedIOUWithQuad:(id)a0;
...
- (id)scaledBy:(struct CGPoint { double x0; double x1; })a0 normalizedOffset:(struct CGPoint { double x0; double x1; })a1;

...
@interface TSWPShapeInfo : TSDShapeInfo <TSDMixing, TSDContainerInfo, TSWPStorageParent, TSWPStorageContainer, TSDSelectionStatisticsContributor, TSWPTextBoxNesting> {
...
+ (unsigned long long)numberOfDifferencesBetweenStyleProperties:(id)a0 betweenOutgoingStorage:(id)a1 outgoingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 incomingStorage:(id)a3 incomingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a4 maxDifferencesBeforeReturning:(unsigned long long)a5;
+ (BOOL)shouldDisableTextMorphsFromPropertiesBetweenOutgoingStorage:(id)a0 outgoingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 incomingStorage:(id)a2 incomingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3;
+ (BOOL)stylesAreEqualWithOutgoingStorage:(id)a0 outgoingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 incomingStorage:(id)a2 incomingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a3;

@class NSString, TSSPropertyMap, NSSet, TSSStylesheet, TSSPropertySet, TSUColor, TSURetainedPointerSet;
...
+ (void)addIgnoreAndPreserveRulesAndDocumentWarningsForPropertyMap:(id)a0 withArchiver:(id)a1 archive:(void *)a2;
+ (id)adjustPropertyMapForFontColorArchiving:(id)a0 fallbackColor:(id)a1;
+ (struct __CTFont { } *)pCreateFontWithName:(id)a0 fontSize:(double)a1;
+ (id)pReplacementForMissingFontName:(id)a0 outBold:(out int *)a1 outItalic:(out int *)a2 outQuiet:(out BOOL *)a3;
+ (BOOL)p_isFillAdvanced:(id)a0;
+ (void)upgradeFontColorToIncludeCharacterFillInPropertyMap:(id)a0 forOwningTSPObject:(id)a1;
+ (id)validateFontInPropertyMap:(id)a0 parentStyle:(id)a1 checkedFontMap:(id)a2;
+ (id)validateFontName:(id)a0 size:(double)a1 bold:(BOOL)a2 italic:(BOOL)a3 checkedFontMap:(id)a4 newFontName:(id *)a5 newBold:(BOOL *)a6 newItalic:(BOOL *)a7;
+ (id)description;
...
- (int)intValueForMUXedProperty:(int)a0;
- (unsigned long long)tst_dataObjectHash;
- (BOOL)tst_dataObjectIsEqual:(id)a0;
- (void)setBoolValue:(BOOL)a0 forProperty:(int)a1;
- (void)upgradeOutlinesToStrokesForcingUpgradeForUnderspecifiedCharacterStyles:(BOOL)a0 overridingCharacterStrokes:(BOOL)a1;
- (id)validateFontWithCheckedFontMap:(id)a0;
- (BOOL)boolValueForProperty:(int)a0 defaultValue:(BOOL)a1;
- (void)loadCharacterStylePropertiesIntoPropertyMap:(id)a0 fromArchive:(const void *)a1 unarchiver:(id)a2;
- (void)loadParagraphStylePropertiesIntoPropertyMap:(id)a0 fromArchive:(const void *)a1 unarchiver:(id)a2;
- (void)p_removeFontColorPropertyInPropertyMap:(id)a0;
- (void)p_upgradeOutlinesToStrokesInPropertyMap:(id)a0 forcingUpgradeForUnderspecifiedCharacterStyles:(BOOL)a1 overridingCharacterStrokes:(BOOL)a2;
...
- (void)saveCharacterStylePropertiesToArchive:(void *)a0 archiver:(id)a1 archivingForCommand:(BOOL)a2;
- (void)saveParagraphStylePropertiesToArchive:(void *)a0 archiver:(id)a1;
- (long long)tswpBorderPositionValueParagraphIsRTL:(BOOL)a0;
- (id)tswpNonNullValueForProperty:(int)a0;

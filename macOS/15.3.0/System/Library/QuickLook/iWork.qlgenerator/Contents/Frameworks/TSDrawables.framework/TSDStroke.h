...
+ (id)emptyStrokeWithWidth:(double)a0;
...
- (void)aaDefeatedPaintLineEnd:(id)a0 atPoint:(struct CGPoint { double x0; double x1; })a1 atAngle:(double)a2 withScale:(double)a3 inContext:(struct CGContext { } *)a4;
- (BOOL)isEqualToStroke:(id)a0;
- (BOOL)isPortalStroke;
- (id)strokeApplyingEmphasis;
- (id)strokeApplyingWidth:(double)a0;
- (double)tswpStrokeExtension;

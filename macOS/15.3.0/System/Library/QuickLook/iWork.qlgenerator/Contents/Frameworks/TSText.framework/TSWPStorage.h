@class NSObject, TSWPPageNumberAttachment, TSDDrawableInfo, TSWPPageCountAttachment, NSMutableString, TSWPCharacterStyle, TSWPStorageBroadcaster, NSString, NSSet, TSDInfoGeometry, TSWPDocumentRoot, TSPObject, NSArray, TSSStylesheet;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeOfInWithinRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeOfLetWithinRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;

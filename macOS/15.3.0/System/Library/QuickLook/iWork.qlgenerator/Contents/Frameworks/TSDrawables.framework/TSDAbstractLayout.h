@class TSDLayoutGeometry, NSArray, TPPageLayout, NSMutableArray;
...
@property (readonly, nonatomic) struct NSEdgeInsets { double x0; double x1; double x2; double x3; } captionEdgeInsets;

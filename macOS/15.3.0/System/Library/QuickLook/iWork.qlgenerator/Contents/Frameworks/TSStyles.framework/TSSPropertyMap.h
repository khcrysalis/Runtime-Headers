...
- (void)pSetArrayOfFloats:(float[9])a0 forProperty:(int)a1;
- (void)pSetArrayOfBools:(BOOL[9])a0 forProperty:(int)a1;
- (void)pSetArrayOfInts:(int[9])a0 forProperty:(int)a1;
- (void)pSetRepeatedArrayOfBools:(const void *)a0 forProperty:(int)a1 defaultValues:(BOOL[9])a2;
- (void)pSetRepeatedArrayOfFloats:(const void *)a0 forProperty:(int)a1 defaultValues:(float[9])a2;
- (void)pSetRepeatedArrayOfInts:(const void *)a0 forProperty:(int)a1 defaultValues:(int[9])a2 min:(int)a3 max:(int)a4;
- (void)pSetRepeatedArrayOfInts:(const void *)a0 forProperty:(int)a1 defaultValues:(int[9])a2 min:(int)a3 max:(int)a4 usePreviousValueOnDefault:(BOOL)a5;
- (void)dealloc;

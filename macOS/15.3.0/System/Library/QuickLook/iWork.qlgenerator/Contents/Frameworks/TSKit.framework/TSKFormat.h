...
- (id)formatByUpdatingIfBaseFormatWithBlock:(id /* block */)a0;
- (id)formatByUpdatingIfCurrencyFormatWithBlock:(id /* block */)a0;
- (id)formatByUpdatingIfDurationFormatWithBlock:(id /* block */)a0;
- (id)formatByUpdatingIfFractionFormatWithBlock:(id /* block */)a0;
- (id)formatByUpdatingIfTSCHNumericFormatWithBlock:(id /* block */)a0;

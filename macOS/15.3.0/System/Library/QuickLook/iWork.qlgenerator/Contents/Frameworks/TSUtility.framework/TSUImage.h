...
- (id)compositeImageWithOverlayImage:(id)a0 overlayTintColor:(id)a1;
- (id)compositedImageWithColor:(id)a0 alpha:(double)a1 blendMode:(int)a2;
- (void)drawInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 context:(struct CGContext { } *)a1 leftCapWidth:(long long)a2 topCapHeight:(long long)a3;
- (void)dealloc;

...
- (id)localizedModeNameForArgument:(short)a0 modeIndex:(short)a1 ofFunction:(id)a2;
- (id)localizedModeToolTipForArgument:(short)a0 modeIndex:(short)a1 ofFunction:(id)a2;
- (id)localizedNameForArgument:(short)a0 ofFunction:(id)a1;
...
- (id)localizedToolTipForArgument:(short)a0 ofFunction:(id)a1;

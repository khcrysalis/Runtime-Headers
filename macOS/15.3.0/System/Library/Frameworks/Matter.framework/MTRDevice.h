...
- (void)_attributeWaitCanceled:(id)a0;
- (void)_attributeWaitTimedOut:(id)a0;
- (void)_delegateAdded;
- (BOOL)_deviceHasActiveSubscription;
- (void)_deviceMayBeReachable;
- (void)_doAttributeWaitCanceled:(id)a0;
...
- (void)_notifyAttributeValueWaiter:(id)a0 withError:(id)a1;

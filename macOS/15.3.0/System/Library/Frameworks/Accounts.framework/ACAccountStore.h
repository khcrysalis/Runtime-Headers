...
- (id)aa_appleAccountWithAltDSID:(id)a0;
- (id)aa_appleAccountWithPersonID:(id)a0;
- (id)aa_primaryAppleAccount;
- (id)aa_appleAccounts;
- (id)aa_grandSlamAccountForAltDSID:(id)a0;
- (id)aa_grandSlamAccountForiCloudAccount:(id)a0;
- (id)aa_dataSeparatedAccounts;
- (void)aa_appleAccountsWithCompletion:(id /* block */)a0;
- (id)aa_accountsEnabledForDataclass:(id)a0;
- (void)_performUpdateRequestWithAccount:(id)a0 serverInfo:(id)a1 completion:(id /* block */)a2;
- (id)aa_accountsForAccountClass:(id)a0;
- (id)aa_appleAccountType;
- (id)aa_appleAccountWithUsername:(id)a0;
- (id)aa_appleAccountsWithError:(id *)a0;
- (id)aa_authKitAccountForAltDSID:(id)a0;
- (BOOL)aa_isUsingiCloud;
- (void)aa_loginAndUpdateiCloudAccount:(id)a0 delegateParams:(id)a1 withCompletion:(id /* block */)a2;
- (void)aa_loginAndUpdateiCloudAccount:(id)a0 withCompletion:(id /* block */)a1;
- (void)aa_primaryAppleAccountWithCompletion:(id /* block */)a0;
- (id)aa_primaryAppleAccountWithPreloadedDataclasses;
- (id)aa_recommendedAppleIDForAccountSignInWithTypeIdentifier:(id)a0;
- (void)aa_registerAppleAccount:(id)a0 withCompletion:(id /* block */)a1;
- (void)aa_registerAppleAccountWithHSA:(id)a0 completion:(id /* block */)a1;
- (void)aa_updatePropertiesForAppleAccount:(id)a0 completion:(id /* block */)a1;
- (void)aa_updatePropertiesForAppleAccount:(id)a0 options:(id)a1 completion:(id /* block */)a2;
- (void)aa_updatePropertiesForAppleAccount:(id)a0 options:(id)a1 serverInfo:(id)a2 completion:(id /* block */)a3;
- (id)accountWithAppleID:(id)a0;
- (id)accountsWithAccountType:(id)a0 appleID:(id)a1;
- (id)_primaryiCloudAccount;
- (id)aida_accountForPrimaryiCloudAccount;
- (id)aida_accountForAltDSID:(id)a0;
- (id)aida_accountForiCloudAccount:(id)a0;
- (id)aida_iCloudAccountMatchingAppleIDAuthAccount:(id)a0;
- (id)aida_AppleIDAuthenticationAccountType;
- (id)aida_AppleIDAuthenticationAccounts;
- (void)aida_renewCredentialsForAccount:(id)a0 services:(id)a1 completion:(id /* block */)a2;
- (void)aida_renewCredentialsForAccount:(id)a0 services:(id)a1 force:(BOOL)a2 completion:(id /* block */)a3;
- (void)dealloc;
- (id)init;
- (void).cxx_destruct;
- (id)_cache;

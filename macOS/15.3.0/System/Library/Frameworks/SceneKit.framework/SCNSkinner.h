...
+ (id)avt_skinnerByInterpolatingFromSkinner:(id)a0 toSkinner:(id)a1 factor:(float)a2 skeleton:(id)a3;
...
- (void)avt_setSimdBaseGeometryBindTransform:(struct { void /* unknown type, empty encoding */ x0[4]; })a0;
- (struct { void /* unknown type, empty encoding */ x0[4]; })avt_simdBaseGeometryBindTransform;
- (void)dealloc;
- (id)copy;

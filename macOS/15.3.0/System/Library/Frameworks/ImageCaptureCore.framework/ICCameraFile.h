...
- (void)rotateLeft;
- (void)rotateOrientation:(char *)a0;
- (void)rotateRight;
- (void)setDownloadedToPath:(id)a0;
- (void)setDownloadedViaDoubleClick:(BOOL)a0;
- (void)setDownloadedViaDragAndDrop:(BOOL)a0;
- (void)setForceNextDownload:(BOOL)a0;
- (void)setThumbnailOrientation:(unsigned char)a0;

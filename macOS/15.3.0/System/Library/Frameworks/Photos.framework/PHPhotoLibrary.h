...
@interface PHPhotoLibrary : NSObject <PNPhotoLibraryProtocol, PHBatchFetchingArrayDataSource, CPLStatusDelegate, PFStateCaptureProvider, PLCPLSettingsObserverDelegate, PHPerformChangesRequest> {
...
+ (BOOL)mad_isProcessingNeededOnAsset:(id)a0 forTaskID:(unsigned long long)a1;
...
- (id)vcp_description;
- (BOOL)mad_performChangesAndWait:(id /* block */)a0 cancelBlock:(id /* block */)a1 extendTimeoutBlock:(id /* block */)a2 error:(id *)a3;
- (BOOL)pn_performChangesAndWait:(id /* block */)a0 error:(id *)a1;
- (id)vcp_vipModelFilepathForVIPType:(unsigned long long)a0;
- (id)_analysisPreferencesURL;
- (id)_defaultAssetFetchOptions;
- (void)_mad_markAsProcessedByTask:(unsigned long long)a0 forAsset:(id)a1;
- (double)_progressFromWorkerStatesDictionary:(id)a0;
- (void)_updateAnalysisPreferencesWithEntries:(id)a0 keysToRemove:(id)a1;
- (id)mad_allFacesFetchOptions;
- (id)mad_allPersonsFetchOptions;
- (id)mad_allPersonsFetchOptionsWithDetectionTypes:(id)a0 andVerifiedTypes:(id)a1;
- (BOOL)mad_calculateProgressPercentage:(unsigned long long *)a0 totalAssetCount:(unsigned long long *)a1 progressPercentageWithFailure:(unsigned long long *)a2 taskID:(unsigned long long)a3 phTaskID:(unsigned long long)a4 priority:(unsigned long long)a5 failedAssetCount:(unsigned long long)a6 error:(id *)a7;
- (id)mad_cloudIdentifierForLocalIdentifier:(id)a0 error:(id *)a1;
...
- (id)mad_localIdentifierForCloudIdentifier:(id)a0 error:(id *)a1;
- (void)mad_markAsProcessedByTask:(unsigned long long)a0 forAssets:(id)a1;
...
- (BOOL)vcp_anyAssetsForTaskID:(unsigned long long)a0;
- (unsigned long long)vcp_assetCountForTaskID:(unsigned long long)a0;
- (unsigned long long)vcp_assetCountForTaskID:(unsigned long long)a0 withPriority:(unsigned long long)a1;
- (unsigned long long)vcp_assetCountWithInternalPredicate:(id)a0 forTaskID:(unsigned long long)a1;
- (unsigned long long)vcp_assetCountWithMediaType:(long long)a0 forTaskID:(unsigned long long)a1;
- (BOOL)vcp_eligibleForStreaming:(BOOL)a0;
...
- (unsigned long long)vcp_processedAssetCountForTaskID:(unsigned long long)a0;
- (unsigned long long)vcp_processedAssetCountForTaskID:(unsigned long long)a0 withPriority:(unsigned long long)a1;
- (unsigned long long)vcp_requiredFaceLibraryProcessingSubTasks;
- (BOOL)vcp_requiresDownloadForTask:(unsigned long long)a0;
- (BOOL)vcp_requiresProcessingForTask:(unsigned long long)a0;
- (void)vcp_setAnalysisPreferencesValue:(id)a0 forKey:(id)a1;
- (BOOL)vcp_supportsInMemoryDownload;
- (id)vcp_vipModelLastGenerationDateForVIPType:(unsigned long long)a0;
...
- (void)_publishChangeToObserversIfAuthorized:(id /* block */)a0;
...
- (id)searchDebugInformationForAssetLocalIdentifier:(id)a0 error:(id *)a1;

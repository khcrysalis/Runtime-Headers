@class NSDictionary, NSArray, NSView, NSString, NSSet, CAMeshTransform;
...
@property (weak, setter=NS_setView:) NSView *NS_view;
...
- (struct { struct CGPoint { double x0; double x1; } x0[3]; })NS_convertTriangle:(struct { struct CGPoint { double x0; double x1; } x0[3]; })a0 toLayer:(id)a1;
- (void)NS_suggestedContentsScaleDidChange;
- (void)NS_contextDefaultContentsScaleDidChange;
- (void)NS_viewVisibleRectDidChange;
- (id)nearestAncestorIgnoringTransformLayers;
- (id)visualTabPicker_hitTestIgnoringTransformLayers:(struct CGPoint { double x0; double x1; })a0 inRootLayer:(id)a1;
- (id)screen;
- (void)mt_applyVisualStying:(id)a0;
- (void)mt_removeAllVisualStyling;
- (void)mt_replaceAllVisualStylingWithStyling:(id)a0;
- (oneway void)release;
- (void)dealloc;

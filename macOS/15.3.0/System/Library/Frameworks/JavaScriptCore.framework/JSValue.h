...
@property (readonly, nonatomic, getter=_isFunction) BOOL _function;
@property (readonly, nonatomic, getter=_isDictionary) BOOL _dictionary;
@property (readonly, nonatomic, getter=_isRegularExpression) BOOL _regularExpression;
@property (readonly, nonatomic, getter=_isThenable) BOOL _thenable;
...
- (void)_awaitThenableResolutionWithCompletionHandler:(id /* block */)a0;
- (id)_toJSONString;

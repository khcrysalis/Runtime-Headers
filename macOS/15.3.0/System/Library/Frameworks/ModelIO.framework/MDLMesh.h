...
+ (id)meshWithSCNGeometry:(id)a0;
+ (id)meshWithSCNGeometry:(id)a0 bufferAllocator:(id)a1;
+ (id)meshWithVFXModel:(id)a0;
+ (id)meshWithVFXModel:(id)a0 bufferAllocator:(id)a1;

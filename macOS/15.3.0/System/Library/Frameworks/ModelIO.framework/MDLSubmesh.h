...
+ (id)newSubmeshWithGeometryData:(id)a0 indexBufferLength:(unsigned long long)a1 interleaved:(BOOL)a2 channelCount:(unsigned long long)a3 channelIdx:(unsigned long long)a4 bytesPerIndex:(unsigned long long)a5 indexType:(unsigned long long)a6 geometryType:(long long)a7 allocator:(id)a8 indexCount:(unsigned long long)a9 topology:(id)a10;
+ (id)newSubmeshWithSCNGeometryElement:(id)a0 bufferAllocator:(id)a1;
+ (id)newSubmeshWithSCNGeometryElement:(id)a0 bufferAllocator:(id)a1 positionSourceChannel:(unsigned long long)a2;
+ (id)newSubmeshWithUniquedIndexData:(id)a0 andSCNGeometryElement:(id)a1 bufferAllocator:(id)a2;
+ (id)submeshWithSCNGeometryElement:(id)a0;
+ (id)submeshWithSCNGeometryElement:(id)a0 bufferAllocator:(id)a1;
+ (id)submeshWithSCNGeometryElement:(id)a0 bufferAllocator:(id)a1 positionSourceChannel:(unsigned long long)a2;
+ (id)submeshWithUniquedIndexData:(id)a0 andSCNGeometryElement:(id)a1 bufferAllocator:(id)a2;
+ (id)newSubmeshWithGeometryData:(id)a0 indexBufferLength:(unsigned long long)a1 interleaved:(BOOL)a2 channelCount:(unsigned long long)a3 channelIdx:(unsigned long long)a4 bytesPerIndex:(unsigned long long)a5 indexType:(unsigned long long)a6 geometryType:(long long)a7 allocator:(id)a8 indexCount:(unsigned long long)a9 topology:(id)a10;
+ (id)submeshWithUniquedIndexData:(id)a0 andVFXModelElement:(id)a1 bufferAllocator:(id)a2;
+ (id)newSubmeshWithUniquedIndexData:(id)a0 andVFXModelElement:(id)a1 bufferAllocator:(id)a2;
+ (id)newSubmeshWithVFXModelElement:(id)a0 bufferAllocator:(id)a1;
+ (id)newSubmeshWithVFXModelElement:(id)a0 bufferAllocator:(id)a1 positionSourceChannel:(unsigned long long)a2;
+ (id)submeshWithVFXModelElement:(id)a0;
+ (id)submeshWithVFXModelElement:(id)a0 bufferAllocator:(id)a1;
+ (id)submeshWithVFXModelElement:(id)a0 bufferAllocator:(id)a1 positionSourceChannel:(unsigned long long)a2;

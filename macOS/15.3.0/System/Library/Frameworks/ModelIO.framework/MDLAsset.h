...
+ (id)assetWithSCNNode:(id)a0;
+ (id)assetWithSCNNode:(id)a0 bufferAllocator:(id)a1;
+ (id)assetWithSCNScene:(id)a0;
+ (id)assetWithSCNScene:(id)a0 bufferAllocator:(id)a1;
+ (id)assetWithVFXNode:(id)a0;
+ (id)assetWithVFXNode:(id)a0 bufferAllocator:(id)a1;
+ (id)assetWithVFXWorld:(id)a0;
+ (id)assetWithVFXWorld:(id)a0 bufferAllocator:(id)a1;

...
- (BOOL)_am_compileOnMainThreadAndReturnError:(id *)a0;
- (void)_am_compileOnMainThreadAndReturnErrorWithDictionary:(id)a0;
- (id)_am_executeAppleEventOnMainThread:(id)a0 error:(id *)a1;
- (void)_am_executeAppleEventOnMainThreadWithDictionary:(id)a0;
- (id)_am_executeOnMainThreadAndReturnError:(id *)a0;
- (void)_am_executeOnMainThreadAndReturnErrorWithDictionary:(id)a0;
- (void)dealloc;

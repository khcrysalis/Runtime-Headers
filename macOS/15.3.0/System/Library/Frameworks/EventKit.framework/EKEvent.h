@class NSURL, IPEventClassificationType, EKImage, NSDate, EKEventStore, EKSuggestedEventInfo, EKVirtualConference, EKCalendarDate, EKParticipant, NSMutableArray, NSString, EKColor, NSSet, IPMessageUnit, EKRecurrenceIdentifier, NSArray, NSNumber, EKStructuredLocation, NSDateComponents;
...
+ (id)participationStatusToString:(long long)a0;

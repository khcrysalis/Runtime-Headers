...
@interface CBDevice : NSObject <HKCBDevice, CUXPCCodable, NSSecureCoding, NSCopying, CBDictionaryCodable> {
    struct { unsigned char bitArray[5]; } _changedTypesInternal;
    struct { unsigned char bitArray[5]; } _discoveryTypesInternal;
}
...
@property (readonly, nonatomic) BOOL isHearingAidCapable;
@property (readonly, nonatomic) BOOL isHearingTestCapable;
...
@property (readonly, nonatomic) struct { unsigned char x0[5]; } *changedTypesInternalPtr;
...
@property (readonly, nonatomic) struct { unsigned char x0[5]; } *discoveryTypesInternalPtr;
...
@property (readonly, nonatomic) unsigned char safetyAlertsAlertIndex;
...
- (BOOL)changedTypesContainTypes:(const struct { unsigned char x0[5]; } *)a0;
...
- (BOOL)discoveryTypesContainTypes:(const struct { unsigned char x0[5]; } *)a0;

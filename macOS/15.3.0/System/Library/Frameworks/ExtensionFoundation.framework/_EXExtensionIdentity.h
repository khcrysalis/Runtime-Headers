...
@interface _EXExtensionIdentity : NSObject <MTSDeviceSetupExtensionIdentity, _EXExtensionConfigurationProviding, NSSecureCoding, _EXExtensionRepresenting>
...
- (id)scenes;
- (id)configurationWithParameters:(id)a0;
- (Class)extensionViewControllerClassForSceneRole:(id)a0;
- (BOOL)isEqual:(id)a0;
- (BOOL)enabled;
- (void).cxx_destruct;

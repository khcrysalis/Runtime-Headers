...
@interface WKProcessPool : NSObject <WKObject, NSSecureCoding> {
    struct ObjectStorage<WebKit::WebProcessPool> { struct type { unsigned char __lx[1072]; } data; } _processPool;
...
- (void)_isJITDisabledInAllRemoteWorkerProcesses:(id /* block */)a0;

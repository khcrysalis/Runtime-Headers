...
@interface WKWebView : NSView <WebViewImplDelegate, NSUserInterfaceValidations, NSTextInputClient, NSTextInputClient_Async, NSTouchBarProvider, NSFilePromiseProviderDelegate, NSDraggingSource, NSScrollViewSeparatorTrackingAdapter, WKShareSheetDelegate, WTWritingToolsDelegate, NSTextInputTraits> {
    ...
    struct RetainPtr<WKIntelligenceTextEffectCoordinator> { void *m_ptr; } _intelligenceTextEffectCoordinator;
...
+ (id)ak_idpWebViewWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 idpHandler:(id)a1;
...
- (void)_disableTextAnimationWithUUID:(id)a0;
...
- (id)_enableFinalTextAnimationForElementWithID:(id)a0;
- (void)_enableFrameSizeUpdates;
- (id)_enableSourceTextAnimationAfterElementWithID:(id)a0;
...
- (void)_setAllowGamepadsInput:(BOOL)a0;

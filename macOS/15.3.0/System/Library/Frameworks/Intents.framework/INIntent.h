@class NSNumber, NSMutableDictionary, INAppIntent, NSDictionary, INParameterContexts, NSOrderedSet, NSString, INIntentDonationMetadata, INPerson, INIntentCodableDescription, INIntentKeyParameter, NSArray, _INPBIntentMetadata, PBCodable, INImage, NSUUID;
...
@property (nonatomic) BOOL didAuthenticateAppProtection;

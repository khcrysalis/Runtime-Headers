@class NSData, NSString, NSArray, UTType, NSDate, SWCollaborationShareOptions, NSDictionary, NSPersonNameComponents, CKContainerSetupInfo, _SWCollaborationMetadataType;

@interface SWCollaborationMetadata : NSObject <NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, NSCopying, NSMutableCopying>

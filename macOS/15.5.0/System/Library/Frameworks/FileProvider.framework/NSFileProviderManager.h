...
+ (id)_br_createNSFileProviderManagerForDataSeparated:(BOOL)a0 withDomainID:(id)a1 didMatchedDomain:(BOOL *)a2;
+ (id)br_getDomainForCurrentPersonaWithError:(id *)a0;
+ (id)br_getDomainForDataSeparated:(BOOL)a0 withIdentifier:(id)a1 withError:(id *)a2;
+ (id)br_getDomainForProvider:(id)a0 withIdentifier:(id)a1 error:(id *)a2;
+ (id)br_getFPDomainsForProviderIdentifier:(id)a0 withError:(id *)a1;
+ (id)br_getLegacyEnterpriseProviderManager;
+ (id)br_getPrimaryProviderManager;
+ (id)br_getProviderManagerForDataSeparated:(BOOL)a0;
+ (id)br_sharedProviderManager;
+ (id)br_sharedProviderManagerWithDomainID:(id)a0;
...
+ (void)addDomain:(id)a0 forProviderIdentifier:(id)a1 byImportingDirectoryAtURL:(id)a2 userAllowedDBDrop:(BOOL)a3 knownFolders:(id)a4 completionHandler:(id /* block */)a5;
+ (void)addDomain:(id)a0 forProviderIdentifier:(id)a1 byImportingDirectoryAtURL:(id)a2 userAllowedDBDrop:(BOOL)a3 knownFolders:(id)a4 synchronous:(BOOL)a5 completionHandler:(id /* block */)a6;
...
+ (void)addDomain:(id)a0 userAllowedDBDrop:(BOOL)a1 completionHandler:(id /* block */)a2;
+ (BOOL)checkDomainsCanBeStored:(BOOL *)a0 onVolumeAtURL:(id)a1 unsupportedReason:(unsigned long long *)a2 error:(id *)a3;
...
- (id)br_getFPDomainForAccount:(id)a0 withError:(id *)a1;
- (id)br_getFPDomainWithIdentifier:(id)a0 withError:(id *)a1;
- (id)br_getFPDomainsWithError:(id *)a0;
- (void)dealloc;
- (id)description;
- (void).cxx_destruct;
- (id)_connection;
...
- (void)_fetchDomainServicer:(id)a0 forProviderDomainID:(id)a1 handler:(id /* block */)a2;
...
- (id)stateDirectoryURLWithError:(id *)a0;

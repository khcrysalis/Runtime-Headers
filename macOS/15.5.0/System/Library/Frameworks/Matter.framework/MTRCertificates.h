...
+ (BOOL)certificate:(id)a0 isCompatibleWithAnotherControllerCertificate:(id)a1;
+ (id)describeMatterCertificate:(id)a0;
+ (id)describeX509Certificate:(id)a0;
+ (id)fabricIDFromCertificate:(id)a0;
+ (void)printMatterCertificate:(id)a0;
+ (void)printX509Certificate:(id)a0;
+ (id)publicKeyDataFromCertificate:(id)a0;
+ (id)shortDescriptionForMatterCertificate:(id)a0;
+ (id)shortDescriptionForX509Certificate:(id)a0;
+ (void)initialize;
...
+ (id)createIntermediateCertificate:(id)a0 rootCertificate:(id)a1 intermediatePublicKey:(struct __SecKey { } *)a2 issuerID:(id)a3 fabricID:(id)a4 validityPeriod:(id)a5 error:(id *)a6;
+ (id)createOperationalCertificate:(id)a0 signingCertificate:(id)a1 operationalPublicKey:(struct __SecKey { } *)a2 fabricID:(id)a3 nodeID:(id)a4 caseAuthenticatedTags:(id)a5 validityPeriod:(id)a6 error:(id *)a7;
+ (id)createRootCertificate:(id)a0 issuerID:(id)a1 fabricID:(id)a2 error:(id *)a3;
+ (id)createRootCertificate:(id)a0 issuerID:(id)a1 fabricID:(id)a2 validityPeriod:(id)a3 error:(id *)a4;

...
- (void)unpairDevice:(id)a0 completionHandler:(id /* block */)a1;
- (void)_fetchPairingsWithCallbackQueue:(id)a0 filtered:(BOOL)a1 vendorMetadataStore:(id)a2 completionHandler:(id /* block */)a3;
- (void)_removeFabricWithIndex:(id)a0 callbackQueue:(id)a1 completionHandler:(id /* block */)a2;
- (id)_retrieveFabricClusterWithQueue:(id)a0;
- (id)_vendorNameForVendorID:(id)a0 vendorMetadataStore:(id)a1;
- (void)fetchCurrentFabricIndexWithCallbackQueue:(id)a0 completionHandler:(id /* block */)a1;
- (void)fetchCurrentPairingWithCallbackQueue:(id)a0 vendorMetadataStore:(id)a1 completionHandler:(id /* block */)a2;
- (void)fetchFabricDescriptorsWithCallbackQueue:(id)a0 filtered:(BOOL)a1 completionHandler:(id /* block */)a2;
- (void)fetchPairingsWithCallbackQueue:(id)a0 vendorMetadataStore:(id)a1 completionHandler:(id /* block */)a2;
- (void)fetchSerialNumberWithCallbackQueue:(id)a0 completionHandler:(id /* block */)a1;
- (void)removeAllPairingsForCallbackQueue:(id)a0 vendorMetadataStore:(id)a1 completionHandler:(id /* block */)a2;
- (void)removePairing:(id)a0 callbackQueue:(id)a1 vendorMetadataStore:(id)a2 completionHandler:(id /* block */)a3;
- (void)updateFabricLabel:(id)a0 callbackQueue:(id)a1 completionHandler:(id /* block */)a2;
- (id)description;
- (void).cxx_destruct;

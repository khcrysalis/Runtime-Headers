...
@property (readonly) BOOL isAltitudeWgs84Available;
...
+ (id)CKDPLocationCoordinateFromCLLocation:(id)a0;
+ (id)CKLocationFromPLocationCoordinate:(id)a0;

...
+ (id)mad_sharedImageEmbeddingVersionProviderWithPhotoLibrary:(id)a0;
+ (id)mad_sharedVersionProviderForBackupWithPhotoLibrary:(id)a0;
+ (id)mad_sharedVersionProviderWithPhotoLibrary:(id)a0;
+ (id)mad_sharedVideoEmbeddingVersionProviderWithPhotoLibrary:(id)a0;

@class NSURL, VNSceneprint, CLLocation, NSDate, CLSAssetProcessedSignals, PHAssetPhotosSmartStyleExtendedProperties, PLLazyObject, CLSCurationModel, NSManagedObjectContext, NSString, NSSet, NSManagedObjectID, CLSAssetFaceInformationSummary, NSArray, PHPhotoLibrary, NSNumber, NSData, NSValue;

@interface PHAsset : PHObject <CLSCurationItem, CLSPHAssetSupportProtocol, CLSPHAssetUserBehaviorProtocol, PHThumbnailAsset, _PLImageLoadingAsset, PHResourceChooserAsset, PLAssetID> {
...
@property (readonly, nonatomic) BOOL faceAnalysisVersionWasFetched;
...
@property (readonly, nonatomic) BOOL isRecoveredAsset;
...
@property (readonly, nonatomic) BOOL is60PlusFPS;
@property (readonly, nonatomic) BOOL hasSpatialAudio;
@property (readonly, nonatomic) BOOL isStyleable;
...
+ (BOOL)mad_disableComputeSync;
+ (float)mad_peopleThreshold;
+ (float)mad_sceneConfidenceThresholdForTask:(unsigned long long)a0;
+ (id)vcp_fetchOptionsForLibrary:(id)a0 forTaskID:(unsigned long long)a1;
+ (unsigned long long)vcp_fullAnalysisGenerativeModelAdditionalTypes;
+ (unsigned long long)vcp_fullAnalysisImageOnlyTypes;
+ (unsigned long long)vcp_fullAnalysisTypesForAssetType:(unsigned long long)a0;
+ (unsigned long long)vcp_longMovieDurationThreshold;
+ (double)vcp_ocrGatingThreshold;
+ (id)vcp_requiredAnalysisForNextAnalysisStage:(short)a0;
+ (BOOL)vcp_usePHFace;
+ (BOOL)vcp_usePHFaceExpression;
+ (id)clsAllAssetsFromFetchResult:(id)a0 prefetchOptions:(unsigned long long)a1 curationContext:(id)a2;
+ (void)prefetchOnAssets:(id)a0 options:(unsigned long long)a1 curationContext:(id)a2;
+ (void)prefetchScenesOnAssets:(id)a0;
+ (unsigned long long)clsPrefetchOptionsForKeyAsset;
+ (BOOL)isScore:(double)a0 closeToValue:(double)a1;
+ (id)verifiedPersonLocalIdentifiersByAssetUUIDWithAssets:(id)a0;
+ (id)_personUUIDsByAssetUUIDWithAssetUUIDs:(id)a0 personUUIDs:(id)a1 photoLibrary:(id)a2;
+ (id)_filterPersonUUIDs:(id)a0 fromPersonUUIDsByAssetUUID:(id)a1 personUUIDByMergeCandidateUUID:(id)a2;
+ (id)_personUUIDsByAssetUUIDWithAssets:(id)a0 personUUIDs:(id)a1;
+ (id)_petUUIDsByAssetUUIDWithAssetUUIDs:(id)a0 photoLibrary:(id)a1;
+ (void)_populateAsset:(id)a0 withPersonUUIDs:(id)a1 consolidatedPersonUUIDs:(id)a2 petUUIDs:(id)a3;
...
+ (id)fetchKeyAssetForEachSuggestion:(id)a0 options:(id)a1 useSuggestionsSortOrder:(BOOL)a2;
...
+ (id)fetchKeyAssetForPerson:(id)a0 options:(id)a1;
...
+ (void)computeStableHashesOfAsset:(id)a0 completionHandler:(id /* block */)a1;
...
+ (id)fetchAnyCinematicVideosNeedingDeferredProcessingWithOtions:(id)a0;
+ (id)fetchAssetsAssociatedWithMomentsOfMemory:(id)a0 options:(id)a1;
+ (id)fetchAssetsCapturedOrEdited:(BOOL)a0 onThisCameraSinceDate:(id)a1 options:(id)a2;
+ (id)fetchAssetsContainingAllPersons:(id)a0 options:(id)a1;
+ (id)fetchAssetsForBehavioralCurationWithOptions:(id)a0;
+ (id)fetchAssetsForComment:(id)a0 options:(id)a1;
+ (id)fetchAssetsForFaceGroups:(id)a0 options:(id)a1;
+ (id)fetchAssetsForFaces:(id)a0 options:(id)a1;
+ (id)fetchAssetsForPTPWithOptions:(id)a0;
+ (id)fetchAssetsForPerson:(id)a0 faceCount:(unsigned long long)a1 options:(id)a2;
...
+ (id)fetchAssetsForSearchLookupIdentifier:(id)a0 options:(id)a1;
+ (id)fetchAssetsForStyleablePhotoSuggestionsWithOptions:(id)a0;
...
+ (id)fetchAssetsMatchingAdjustedStableHash:(id)a0 photoLibrary:(id)a1;
+ (id)fetchAssetsMatchingMasterFingerPrint:(id)a0 photoLibrary:(id)a1;
+ (id)fetchAssetsMatchingOriginalStableHash:(id)a0 photoLibrary:(id)a1;
+ (id)fetchAssetsThroughGraphEdgesForPerson:(id)a0 options:(id)a1;
...
+ (id)fetchCollageAssetsForDayHighlight:(id)a0 options:(id)a1;
...
+ (id)fetchExclusiveAssetsForSocialGroup:(id)a0 options:(id)a1;
+ (id)fetchExclusiveSocialGroupAssetsForPersons:(id)a0 minimumNumberOfSharedAssets:(unsigned long long)a1 options:(id)a2 error:(id *)a3;
+ (id)fetchExclusiveSocialGroupAssetsForPersons:(id)a0 options:(id)a1 error:(id *)a2;
...
+ (id)fetchInclusiveAssetsForSocialGroup:(id)a0 options:(id)a1;
...
+ (id)fetchKeyAssetForExtendedSceneIdentifier:(unsigned long long)a0 aboveConfidenceThreshold:(double)a1 minimumSceneAnalysisVersion:(short)a2 options:(id)a3;
...
+ (id)fetchKeyAssetForSocialGroup:(id)a0 createIfNeeded:(BOOL)a1 options:(id)a2;
+ (id)fetchKeyAssetForSocialGroup:(id)a0 options:(id)a1;
+ (id)fetchKeyAssetsForCollectionList:(id)a0 options:(id)a1;
...
+ (id)fetchSummaryCurationForHighlight:(id)a0 fetchOptions:(id)a1 allowsOnDemand:(BOOL)a2 error:(id *)a3;
...
+ (id)fetchUserHiddenAssetsWithOptions:(id)a0;
+ (id)fetchVisibleAssetsWithObjectIDs:(id)a0 options:(id)a1;
...
+ (id)internalSortDescriptorsWithCreationDateAscending:(BOOL)a0;
...
- (short)mad_analysisStageAfterCompletingAnalysis:(unsigned long long)a0;
- (short)mad_analysisStageAfterDroppingAnalysis:(unsigned long long)a0;
- (BOOL)mad_isEligibleForAnalysis:(unsigned long long)a0;
- (BOOL)mad_isEligibleForComputeSync;
- (BOOL)mad_isEligibleForComputeSyncDownloadWithAnalysisTask:(unsigned long long)a0;
- (BOOL)mad_isEligibleForComputeSyncIngestion;
- (BOOL)mad_isNonLivePhotoImage;
- (BOOL)mad_needsImageEmbeddingProcessing;
- (BOOL)mad_needsProcessingForComputeSyncWithAnalysis:(unsigned long long)a0;
- (BOOL)mad_needsVideoEmbeddingProcessing;
- (id)mad_nextAttemptDateForStatus:(unsigned long long)a0 currentAttemptDate:(id)a1 attemptCount:(unsigned long long)a2;
- (id)mad_refetchAsset;
- (id)vcp_PHFaces:(id)a0;
- (unsigned long long)vcp_abnormalImageDimensionForSceneNet;
- (id)vcp_animatedStickerScore;
- (id)vcp_confidenceForExtendedSceneIdentifier:(unsigned long long)a0;
- (BOOL)vcp_eligibleForVideoDownload:(id)a0;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })vcp_faceRectFrom:(id)a0;
- (id)vcp_fingerprint:(id)a0;
- (unsigned long long)vcp_flagsForPHFace:(id)a0 withFaceRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;
- (unsigned long long)vcp_fullAnalysisTypes;
- (unsigned long long)vcp_fullAnalysisTypesForResources:(id)a0;
- (BOOL)vcp_hasAdjustments:(id)a0;
- (BOOL)vcp_isDownloadGated;
- (BOOL)vcp_isPano;
- (BOOL)vcp_isShortMovie;
- (BOOL)vcp_isVideoSlowmo;
- (BOOL)vcp_isVideoTimelapse;
- (unsigned long long)vcp_majorDimensionForResource:(id)a0 withTargetResolution:(unsigned long long)a1;
- (id)vcp_modificationDate;
- (BOOL)vcp_needSceneProcessing;
- (BOOL)vcp_needsFaceProcessing;
- (BOOL)vcp_needsFullAnalysisProcessing:(BOOL)a0;
- (BOOL)vcp_needsOCRProcessing;
- (BOOL)vcp_needsPECProcessing;
- (BOOL)vcp_needsProcessingForTask:(unsigned long long)a0;
- (BOOL)vcp_needsStickerGatingProcessing;
- (unsigned long long)vcp_ocrMajorDimensionForResource:(id)a0;
- (struct CGSize { double x0; double x1; })vcp_originalSize;
- (id)vcp_passedOCRGating;
- (int)vcp_queryPHFaces:(unsigned long long *)a0 results:(id *)a1;
- (unsigned long long)vcp_targetMajorDimensionForImageWithWidth:(unsigned long long)a0 height:(unsigned long long)a1 andMinPreferredMinorDimension:(unsigned long long)a2;
...
- (BOOL)isRegularGem;
- (BOOL)isShinyGem;
- (double)clsIconicSceneScoreWithSceneGeography:(id)a0;
- (void)cacheCurationScore:(double)a0;
...
- (double)cropScoreForTargetAspectRatio:(double)a0 forFaces:(BOOL)a1;
- (BOOL)prepareWithAlternateJunkingHeuristics:(BOOL)a0 withContext:(id)a1 curationContext:(id)a2;
- (BOOL)clsIsGuestAsset;
- (BOOL)clsFaceInformationArePrefetched;
- (void)clsCacheIconicSceneScore:(double)a0;
- (void)clsCacheIsUtility:(BOOL)a0;
- (double)clsContentScoreRecomputingIfNeeded:(BOOL)a0;
- (BOOL)clsPeopleCountIsPrefetched;
- (BOOL)clsPersonLocalIdentifiersArePrefetched;
- (BOOL)clsSceneClassificationsArePrefetched;
- (void)clsSetConsolidatedPersonLocalIdentifiers:(id)a0;
- (void)clsSetFaceInformationSummary:(id)a0;
- (void)clsSetPeopleCount:(id)a0;
- (void)clsSetPersonLocalIdentifiers:(id)a0;
- (void)clsSetPetLocalIdentifiers:(id)a0;
- (void)clsSetProcessedSignals:(id)a0;
- (void)clsSetSceneClassifications:(id)a0;
- (double)clsVideoScore;
- (double)clsWallpaperScore;
- (BOOL)isGold;
- (BOOL)isSubtype:(unsigned long long)a0;
- (void).cxx_destruct;
- (short)kind;
...
- (id)objectReference;
- (id)pl_photoLibrary;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })suggestedCropForAspectRatio:(double)a0 withFocusRegion:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 andOutputCropScore:(out double *)a2;
- (id)pl_managedAsset;
...
- (id)_sceneClassificationsWithPredicate:(id)a0;
- (void)_setupAdjustmentAndDeferredProcessingAttributesFromFetchDictionary:(id)a0;
- (void)_setupAnalysisScoreAttributesFromFetchDictionary:(id)a0;
- (void)_setupAuxiliaryIdentifierAttributesFromFetchDictionary:(id)a0;
- (void)_setupBadgeAttributesFromFetchDictionary:(id)a0;
- (void)_setupFaceAttributesFromFetchDictionary:(id)a0;
- (void)_setupFileSystemAttributesFromFetchDictionary:(id)a0;
- (void)_setupGeometryAttributesFromFetchDictionary:(id)a0;
- (void)_setupHDRAndDepthMediaSubtypesFromFetchDictionary:(id)a0;
- (void)_setupKindSubtypeFromFetchDictionary:(id)a0;
- (void)_setupLocationAndCreationDateAttributesFromFetchDictionary:(id)a0;
- (void)_setupSmartStyleFromFetchDictionary:(id)a0;
- (void)_setupSpatialTypeFromFetchDictionary:(id)a0;
- (void)_setupTypeAndPersistenceStateAttributesFromFetchDictionary:(id)a0;
- (void)_setupUIStateAndTrashAttributesFromFetchDictionary:(id)a0;
...
- (void)getOriginalStableHashWithCompletionHandler:(id /* block */)a0;
...
- (id)sceneClassificationsOfTypes:(id)a0;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })suggestedCropForTargetSize:(struct CGSize { double x0; double x1; })a0 withFocusRegion:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 andOutputCropScore:(out double *)a2;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })suggestedCropForTargetSize:(struct CGSize { double x0; double x1; })a0 withOcclusionRegion:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 andOutputCropScore:(out double *)a2;

...
@property (class, readonly) int minSDOFRenderingVersionSupported;
@property (class, readonly) int maxSDOFRenderingVersionSupported;
...
+ (struct CGImageMetadata { } *)_imageMetadataFromFilters:(id)a0 inputImageExtent:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1;

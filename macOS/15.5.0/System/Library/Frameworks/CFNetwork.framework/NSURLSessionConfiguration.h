...
@property (setter=_setAllowsUCA:) BOOL _allowsUCA;
...
@property BOOL _forceEnablePQTLS;
...
@property (readonly) BOOL _inPrivateBrowsing;
@property BOOL _systemClientOfPrivateAccessTokens;
...
- (void)geo_configureWithRequest:(id)a0;
- (BOOL)geo_hasApplicationAttribution:(id)a0;
- (BOOL)geo_isCompatibleWithRequest:(id)a0;
- (void)geo_setApplicationAttribution:(id)a0;
- (void)aa_registerProtocolClass:(Class)a0;
- (void)aa_unregisterProtocolClass:(Class)a0;
- (void)dealloc;

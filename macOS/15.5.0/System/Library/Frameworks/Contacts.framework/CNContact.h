@class NSURL, NSDateComponents, NSDate, NSObject, NSDictionary, CNWallpaper, CNContactKeyVector, CNWallpaperMetadata, CRRecentContact, NSString, SGRecordId, NSSet, NSPersonNameComponents, CNActivityAlert, NSArray, NSData, CNSensitiveContentConfiguration, NSUUID;
@protocol OS_os_log, CNKeyDescriptor;

@interface CNContact : NSObject <TUSearchResult, CNSuggested, CNContactAugmentation, NSItemProviderReading, NSItemProviderWriting, NSCopying, NSMutableCopying, NSSecureCoding> {
...
@property (class, readonly, nonatomic) NSArray *keysToFetchForFaceTime;
...
+ (id)contactWithPkDictionary:(id)a0;
+ (id)pkContactWithNameComponents:(id)a0 labeledValues:(id)a1;
+ (id)pkContactWithNameComponents:(id)a0 postalAddresses:(id)a1 emailAddresses:(id)a2 phoneNumbers:(id)a3;
+ (id)pkContactWithNameFromContact:(id)a0 labeledValue:(id)a1 property:(id)a2;
+ (id)pkPassbookRequiredKeys;
+ (id)pk_predicateForContactsMatchingEmailAddress:(id)a0;
+ (id)pk_predicateForContactsMatchingPhoneNumber:(id)a0;
+ (id)tu_contactHandlesForHandle:(id)a0;
+ (id)pl_findBestMatchingContactFromMatchingContacts:(id)a0 firstName:(id)a1 lastName:(id)a2 contactFormatter:(id)a3;
...
- (BOOL)_maps_isEqualToContact:(id)a0;
- (id)CalEmailAddresses;
- (id)CalFirstValueForKey:(id)a0;
- (id)CalValueForKey:(id)a0 withLabel:(id)a1;
- (id)CalPhoneNumbers;
- (id)CalBirthdayStringForDate:(id)a0;
- (id)CalDisplayName;
- (BOOL)_im_isEqualToContact:(id)a0;
- (id)nameComponents;
- (id)_fullNameFromComponents:(id)a0 style:(long long)a1;
- (id)_phoneticNameFromComponents:(id)a0 style:(long long)a1;
- (id)contactWithCleanedUpDistrict;
- (BOOL)isSubsetOfMeCard;
- (void)pkAddLabeledValues:(id)a0 withProperty:(id)a1;
- (id)pkContactWithCleanedUpCountryCode;
- (id)pkDeconstructContactUsingKey:(id)a0;
- (id)pkDeconstructContactUsingKey:(id)a0 substring:(id)a1;
- (id)pkDictionaryForProperty:(id)a0;
- (id)pkFormattedContactAddress;
- (id)pkFormattedContactAddressIncludingPhoneticName:(BOOL)a0;
- (id)pkFormattedContactAddressIncludingPhoneticName:(BOOL)a0 showName:(BOOL)a1;
...
- (id)pkSingleLineFormattedContactAddressIncludingCountryName:(BOOL)a0;
- (id)pk_displayName;
- (BOOL)representsContact:(id)a0 forContactKeys:(id)a1;
- (id)sanitizedContact;
- (id)tu_labeledValueForEmailAddress:(id)a0;
- (id)allTUHandles;
- (id)tuHandlesForEmailAddresses;
- (id)tuHandlesForPhoneNumbers;
- (id)tu_labeledValueForHandle:(id)a0;
- (id)tu_labeledValueForPhoneNumber:(id)a0;
- (id)tu_labeledValueForSocialProfileWithUsername:(id)a0;
- (id)tu_localizedDisplayStringForHandle:(id)a0;

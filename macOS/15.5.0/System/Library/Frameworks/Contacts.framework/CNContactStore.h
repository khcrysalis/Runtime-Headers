@class NSString, CNResult, NSData, CNContainerCache;

@interface CNContactStore : NSObject <TUConversationContactProvider, TUHandleContactProvider, TUContactProvider, TUContactsDataSource> {
    CNContainerCache *_containerCache;
}

@property (class, readonly, nonatomic, getter=tu_isAuthorized) BOOL tu_authorized;
@property (class, readonly, nonatomic) CNContactStore *tu_contactStore;
...
- (id)contactForDestinationId:(id)a0;
- (id)contactForDestinationId:(id)a0 keysToFetch:(id)a1;
- (id)contactForIdentifier:(id)a0 keysToFetch:(id)a1;
- (id)contactForIdentifier:(id)a0 keysToFetch:(id)a1 usingCache:(id)a2;
- (id)tu_contactsByContactHandleForContactHandles:(id)a0 keyDescriptors:(id)a1 error:(id *)a2;
- (id)tu_contactsByConversationMemberForConversationMembers:(id)a0 keyDescriptors:(id)a1 error:(id *)a2;
- (id)tu_contactsByHandleForHandles:(id)a0 keyDescriptors:(id)a1 error:(id *)a2;
- (id)tu_contactsByRemoteConversationMemberForConversations:(id)a0 keyDescriptors:(id)a1 error:(id *)a2;
- (id)tu_contactsForContactHandles:(id)a0 keyDescriptors:(id)a1 error:(id *)a2;
- (id)tu_contactsForHandles:(id)a0 keyDescriptors:(id)a1 error:(id *)a2;
- (id)tu_enumeratorForChangeHistoryFetchRequest:(id)a0 error:(id *)a1;
- (id)_allContactIDsMatchingPredicate:(id)a0 keysToFetch:(id)a1;
- (id)allContactIDsMatchingEmailAddress:(id)a0;
- (id)allContactIDsMatchingEmailAddress:(id)a0 orPhoneNumber:(id)a1;
- (id)contactsMatchingEmailAddress:(id)a0 keysToFetch:(id)a1;
- (id)contactsMatchingPhoneNumber:(id)a0 keysToFetch:(id)a1;
- (id)init;
- (void).cxx_destruct;

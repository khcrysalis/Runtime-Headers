...
@interface WKProcessPool : NSObject <WKObject, NSSecureCoding> {
    struct ObjectStorage<WebKit::WebProcessPool> { struct type { unsigned char __lx[1232]; } data; } _processPool;
...
+ (void)_setEnableMetalDebugDeviceInNewGPUProcessesForTesting:(BOOL)a0;
+ (void)_setEnableMetalShaderValidationInNewGPUProcessesForTesting:(BOOL)a0;

...
+ (id)akInkFromInk:(id)a0 color:(id)a1 strokeWidth:(double)a2;
+ (id)akDefaultInkWithHighVisibility:(BOOL)a0;
+ (id)akDefaultInkWithIdentifier:(id)a0 color:(id)a1 strokeWidth:(double)a2;
+ (id)akInkFromInk:(id)a0 strokeWidth:(double)a1;
+ (double)inkWeightFromAKValue:(double)a0;

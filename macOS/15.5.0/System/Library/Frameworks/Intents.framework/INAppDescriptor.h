...
@property (readonly, nonatomic, getter=isProbablySecondParty) BOOL probablySecondParty;
@property (readonly, nonatomic, getter=isShortcutsApp) BOOL shortcutsApp;
...
- (BOOL)isEqualForSmartPromptPurposes:(id)a0;

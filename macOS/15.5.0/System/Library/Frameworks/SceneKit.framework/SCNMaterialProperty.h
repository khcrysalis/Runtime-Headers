@class NSColor, NSArray, NSString, NSMutableDictionary, SCNOrderedDictionary;
...
@interface SCNMaterialProperty : NSObject <SCNAnimatable, NSSecureCoding> {
    ...
    struct CATransform3D { double x0; double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; } *_contentTransform;
    id _runtimeResolvedPath;
}

@property (class, readonly) BOOL supportsSecureCoding;

@property (nonatomic, setter=avt_setSimdContentsTransform:) struct { void /* unknown type, empty encoding */ x0[4]; } avt_simdContentsTransform;
...
+ (struct __C3DImage { } *)_createC3DImageFromImage:(id)a0;

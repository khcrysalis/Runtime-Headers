...
- (void)resetSpillingRangesInUIDRanges:(const void *)a0;
...
- (int)getValue:(id *)a0 atCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a1 fetchRichTextAttributesIfPlainText:(BOOL)a2;
...
- (BOOL)hasSpillRangesIntersectingCellRegion:(id)a0;
...
- (void)modifiedTextPropertiesForCategoryOrPivotCellAtCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a0 wraps:(BOOL *)a1 padding:(id *)a2 alignment:(int *)a3;
...
- (struct vector<TSKUIDStructTract, std::allocator<TSKUIDStructTract>> { struct TSKUIDStructTract *x0; struct TSKUIDStructTract *x1; struct __compressed_pair<TSKUIDStructTract *, std::allocator<TSKUIDStructTract>> { struct TSKUIDStructTract *x0; } x2; })spillingRangesInRegion:(id)a0;

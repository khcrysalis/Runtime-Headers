...
- (struct CGImage { } *)i_imageInScaledRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 withTargetIntegralSize:(struct CGSize { double x0; double x1; })a1 distortedToMatch:(BOOL)a2 preservingContentHeadroom:(inout double *)a3 tonemappedHDRContentToSDR:(BOOL *)a4 keepingChildrenPassingTest:(id /* block */)a5;
...
- (struct CGImage { } *)i_newImageInContext:(struct CGContext { } *)a0 bounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a1 integralBounds:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a2 distortedToMatch:(BOOL)a3 tonemappedHDRContentToSDR:(BOOL *)a4 keepingChildrenPassingTest:(id /* block */)a5;

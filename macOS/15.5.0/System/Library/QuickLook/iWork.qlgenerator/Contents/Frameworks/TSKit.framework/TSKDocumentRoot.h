@class TSKPasteboardController, NSString, TSKChangeNotifier, TSSTheme, TSKAccessController, NSDictionary, TSKDocumentSupport, TSULocale, TSSStylesheet, TSKAnnotationAuthorStorage, TSKSelectionDispatcher, TSKAnnotationAuthor;
...
- (id)tsch_textCacheForStyleProvidingSource:(id)a0;
- (void)setTheme:(id)a0;
- (void)setThemeForTemplateImport:(id)a0;
- (void)migrateStylesInObjects:(id)a0;
- (id)migratedStyleForStyle:(id)a0;
...
- (void)migrateStylesInObjects:(id)a0 changePropagationMap:(id)a1;
- (id)migratedPresetForPreset:(id)a0;
- (id)migratedPropertyMapForPropertyMap:(id)a0;
- (void)dealloc;
- (void).cxx_destruct;

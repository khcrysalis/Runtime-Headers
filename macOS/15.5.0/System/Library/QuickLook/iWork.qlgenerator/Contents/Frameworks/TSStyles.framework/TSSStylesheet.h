@class NSString, NSArray, TSURetainedPointerKeyDictionary, NSSet, NSMutableDictionary, TSWPParagraphStyle, TSUMutableRetainedPointerSet;
...
+ (id)p_presenterNotesListStyleIdentifierForListLabelType:(unsigned long long)a0;
+ (id)presenterNotesParagraphStyleIdentifier;
+ (id)variationMapForVaryingCharacterStyle:(id)a0 overParagraphStyle:(id)a1 withPropertyMap:(id)a2;
+ (id)variationMapForVaryingStyle:(id)a0 overStyles:(id)a1 withPropertyMap:(id)a2;

- (void)addDefaultPresenterNotesStylesIfAbsent;
- (id)allPresenterNotesStyles;
- (id)p_boxedLabelTypesForNotesListStyles;
- (id)p_defaultPresenterNotesListStylePropertyMapForListLabelType:(unsigned long long)a0;
- (id)p_defaultPresenterNotesParagraphStylePropertyMap;
- (id)p_defaultPresenterNotesParagraphStyleWithContext:(id)a0;
- (id)p_newDefaultPresenterNotesListStyleWithContext:(id)a0 forListLabelType:(unsigned long long)a1;
- (void)p_upgradeDefaultPresenterNotesStylesResetExisting:(BOOL)a0;
- (id)stickyCommentStyles;
- (void)upgradeDefaultPresenterNotesStyles;
- (id)addDuplicateOfStyle:(id)a0 withIdentifier:(id)a1;
...
- (id)_defaultDropCapStyleWasCreated:(BOOL *)a0;
- (id)_defaultTOCEntryStyleWasCreated:(BOOL *)a0;
- (id)defaultDropCapStyle;
- (id)defaultEquationStyle;
- (id)defaultTOCEntryStyle;
- (id)variationOfDropCapStyle:(id)a0 characterStyle:(id)a1 paragraphStyle:(id)a2 propertyMap:(id)a3;
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;

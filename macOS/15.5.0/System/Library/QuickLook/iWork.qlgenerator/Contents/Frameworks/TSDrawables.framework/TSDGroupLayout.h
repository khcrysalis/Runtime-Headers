@class TSDLayoutGeometry, NSString, NSOrderedSet, TSUBezierPath;

@interface TSDGroupLayout : TSDContainerLayout <TSWPStyleProviding, TSDWrappableParent> {
...
- (BOOL)tswp_shouldProvideStylesForLayout:(id)a0;
- (void).cxx_destruct;
- (void)invalidate;

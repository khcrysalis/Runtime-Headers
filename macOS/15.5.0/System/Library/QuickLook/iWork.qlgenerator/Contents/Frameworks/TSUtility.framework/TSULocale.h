...
+ (id)localeIdentifierWithLanguageVariantAndRegionSubtagRemoved:(id)a0;
+ (id)regionSubtagAwareComponentsFromLocaleIdentifier:(id)a0;

- (id)supportedFunctions;
- (id)functionNameForLocalizedString:(id)a0;
- (id)_localizedStringFromArgumentsTable:(id)a0;
...
- (id)localizedCategoryForFunction:(id)a0;
- (id)localizedFalseString;
- (id)localizedFalseStrings;
- (id)localizedFunctionCategoryDictionary;
- (id)localizedFunctionNameForMenuTag:(int)a0;
- (id)localizedLabelForAggType:(unsigned char)a0;
- (id)localizedLabelForShowAsType:(unsigned char)a0;
- (id)localizedLambdaIdentifierForArgument:(unsigned long long)a0 identifierIndex:(short)a1 ofFunction:(id)a2;
- (id)localizedModeNameForArgument:(unsigned long long)a0 modeIndex:(short)a1 ofFunction:(id)a2;
- (id)localizedModeToolTipForArgument:(unsigned long long)a0 modeIndex:(short)a1 ofFunction:(id)a2;
- (id)localizedNameForArgument:(unsigned long long)a0 ofFunction:(id)a1;
- (id)localizedNameForFunction:(id)a0;
- (id)localizedNamesForFunctions:(id)a0;
- (id)localizedShortLabelForAggType:(unsigned char)a0;
- (BOOL)localizedStringIsFalse:(id)a0;
- (BOOL)localizedStringIsTrue:(id)a0;
- (id)localizedToolTipForArgument:(unsigned long long)a0 ofFunction:(id)a1;
- (id)localizedToolTipForFunction:(id)a0;
- (id)localizedTrueString;
- (id)localizedTrueStrings;
- (id)localizedTypeStringForArgumentType:(char)a0;
- (void)dealloc;
- (id)description;

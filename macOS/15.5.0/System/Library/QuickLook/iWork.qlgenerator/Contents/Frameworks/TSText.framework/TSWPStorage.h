@class NSObject, TSWPPageNumberAttachment, TSDDrawableInfo, TSWPPageCountAttachment, NSMutableString, TSWPCharacterStyle, TSWPDeletionRangeMap, TSWPStorageBroadcaster, NSString, NSSet, TSDInfoGeometry, TSWPDocumentRoot, TSPObject, NSArray, TSSStylesheet;
...
@interface TSWPStorage : TSPObject <TSDDrawableContainerInfo, TSKPencilAnnotationContainer, TSKTransformableObject, TSWPStyleProvider, TSWPStorageParent, TSSStyleClient, TSWPTextSource, TSPCopying> {
    ...
    unsigned char _usesSystemFonts : 1;
...
@property (nonatomic) struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; } hyperlinkCellID;
...
@property (nonatomic) BOOL usesSystemFonts;
...
+ (id)filterText:(id)a0 flags:(unsigned long long)a1;
...
- (id)defaultSectionForContext:(id)a0;
- (id)uuidPathPrefixComponentsProvider;
- (id)mergeSmartFields;
- (struct TPSectionEnumerator { id x0; unsigned long long x1; struct _NSRange { unsigned long long x0; unsigned long long x1; } x2; struct _NSRange { unsigned long long x0; unsigned long long x1; } x3; })sectionEnumeratorAtCharIndex:(unsigned long long)a0;
- (struct TPSectionEnumerator { id x0; unsigned long long x1; struct _NSRange { unsigned long long x0; unsigned long long x1; } x2; struct _NSRange { unsigned long long x0; unsigned long long x1; } x3; })sectionEnumeratorAtSectionIndex:(unsigned long long)a0;
- (struct TPSectionEnumerator { id x0; unsigned long long x1; struct _NSRange { unsigned long long x0; unsigned long long x1; } x2; struct _NSRange { unsigned long long x0; unsigned long long x1; } x3; })sectionEnumeratorForCharRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (id)sectionFillForAttachment:(id)a0;
- (id)rangesForLocalization;
- (struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })hyperlinkCellID;
- (BOOL)changesWithPageCount;
- (BOOL)hasAttachmentsThatChangeWithPageNumberOrPageCount;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a0 includingBreak:(BOOL)a1;
- (void)setHyperlinkCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a0;
- (id)tst_tableInfo;
- (BOOL)argumentStartsAtInsertionPoint:(unsigned long long)a0;
- (void)detokenizeEntireStorage;
- (BOOL)hasDamagedTokenAttachments;
- (id)i_copyIntoContext:(id)a0 stylesheet:(id)a1;
- (id)i_copyIntoContext:(id)a0 stylesheet:(id)a1 paragraphStyle:(id)a2 listStyle:(id)a3 bakeModes:(BOOL)a4 resettingHostTableToMatch:(id)a5 referenceColorHelper:(id)a6 disableMenus:(BOOL)a7;
- (unsigned int)inProgressArgumentIndexAtInsertionPoint:(unsigned long long)a0 forFunctionNode:(id)a1;
- (id)inProgressFunctionAtInsertionPoint:(unsigned long long)a0;
- (void)inProgressFunctions:(void *)a0 atInsertionPoint:(unsigned long long)a1;
- (void)insertUIGraphicalAttachment:(id)a0;
- (void)insertUIGraphicalAttachment:(id)a0 withLanguage:(id)a1;
- (BOOL)isFormulaSyntaxErrorEqual:(id)a0;
- (unsigned long long)nextNonWhitespaceOrNewlineIndexStartingAtIndex:(unsigned long long)a0;
- (void)nonUndoableAppendStoragePreservingEmphasis:(id)a0;
- (void)p_detokenizeEverythingInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (void)p_detokenizeTokenAtCharIndex:(unsigned long long)a0;
- (id)p_processEndNode:(id)a0 startNode:(id)a1 bakeModes:(BOOL)a2 tokenDict:(id)a3;
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_rangeOfString:(id)a0 orNodeClass:(Class)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2;
- (void)p_replaceMixedDirectionText:(id)a0 atRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (void)p_replaceTokenAtCharIndex:(unsigned long long)a0 withText:(id)a1;
- (void)p_replaceUnknownDirectionText:(id)a0 atRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (id)p_stringWithFormulaAsTextFromRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 returningTokenValues:(BOOL)a1;
- (unsigned long long)previousNonWhitespaceOrNewlineIndexStartingAtIndex:(unsigned long long)a0;
- (void)replaceText:(id)a0 atRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1;
- (void)replaceText:(id)a0 withLanguage:(id)a1 atRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2;
- (id)stringWithFormulaDetokenizedText;
- (id)stringWithFormulaDetokenizedTextFromRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (id)stringWithFormulaPlainText;
- (id)stringWithFormulaPlainTextFromRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (void)takeText:(id)a0;
- (void)takeText:(id)a0 withLanguage:(id)a1;
- (unsigned long long)tst_dataObjectHash;
- (BOOL)tst_dataObjectIsEqual:(id)a0;
- (id)tst_selectionForImplicitlyEditingCellWithFormat:(id)a0 adjustSelectionForCurrencyOrPercentSymbols:(BOOL)a1;
- (id)tst_selectionForImplicitlyEditingWithFormatType:(unsigned int)a0 percentSymbol:(id)a1 currencySymbol:(id)a2 adjustSelectionForCurrencyOrPercentSymbols:(BOOL)a3;
- (void)variablesDefined:(id)a0 atInsertionPoint:(unsigned long long)a1;
- (void)dealloc;
- (void).cxx_destruct;
...
- (BOOL)hasObject:(id)a0 attributeArrayKind:(unsigned long long)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 findUsingExactRangeLocation:(BOOL)a3;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_removeOverlappingFieldsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 attributeKind:(unsigned long long)a1 undoTransaction:(void *)a2;
- (void)removeDisallowedSmartFieldKind:(unsigned short)a0;
- (int)writingDirectionFromBidiAttributesTableForParagraphAtCharIndex:(unsigned long long)a0;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })annotationRangeForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
...
- (unsigned long long)charIndexAfterAnyAnchoredAttachmentsAtCharIndex:(unsigned long long)a0;
...
- (id)dropCapCharIndexesInSelection:(id)a0;
- (id)dropCapStyleIfMatchingSelectionExactly:(id)a0;
- (id)effectiveFontAtCharIndex:(unsigned long long)a0;
...
- (void)enumerateBookmarksInSelection:(id)a0 usingBlock:(id /* block */)a1;
...
- (void)enumerateHighlightsInSelection:(id)a0 usingBlock:(id /* block */)a1;
- (void)enumerateHighlightsInSelectionExpandedRange:(id)a0 usingBlock:(id /* block */)a1;
...
- (id)filteredStorageForWritingToolsWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
...
- (BOOL)hasObject:(id)a0 attributeArrayKind:(unsigned long long)a1 range:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2;
...
- (id)indexesSetForBIUProperties:(id)a0 styles:(id)a1;
...
- (BOOL)isAllWhitespaceInSelection:(id)a0;
...
- (void)nonUndoableFilterInvalidContentForStorage:(id)a0 keepHighlights:(BOOL)a1 nestingDepth:(long long)a2 rangesToUpdate:(id)a3;
...
- (void)p_createAttributeTablesIfNeededWithListStyleFlag:(BOOL)a0;
- (void)p_deduplicateAttributeObjectsWithVersion:(unsigned long long)a0 hasPreUFFVersion:(BOOL)a1;
...
- (void)p_finalizeLoadingFromUnarchiverWithTimes:(const double *)a0 isInDocument:(BOOL)a1 isFromCopy:(BOOL)a2 hasTableListStyle:(BOOL)a3 isCrossAppPaste:(BOOL)a4 hasPreUFFVersion:(BOOL)a5 fileFormatVersion:(unsigned long long)a6;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_parIndexRangeForTextSourceForCharacterRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })p_relocateNonSelectedAnchorsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 selectedInfos:(id)a1 undoTransaction:(void *)a2;
- (void)p_repairAttachments;
- (void)p_repairAttributeArrays;
- (void)p_repairComments;
- (void)p_repairHyperlinksWithVersion:(unsigned long long)a0 hasPreUFFVersion:(BOOL)a1;
...
- (id)p_replacementsForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withString:(id)a1 replaceTextData:(id)a2 changeSession:(id)a3 shouldTrackDeletions:(BOOL)a4;
- (BOOL)p_shouldAcceptChangesForRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 copiedRanges:(id)a1 removeDeletedText:(BOOL *)a2;
...
- (id)paragraphIndicesForSelection:(id)a0;
- (BOOL)phoneticsExistInSelection:(id)a0;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })rangeForSelectionWithInsertionLocation:(unsigned long long)a0;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })removePencilAnnotationsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 undoTransaction:(void *)a1;
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })replaceCharactersInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withString:(id)a1 notifyObservers:(BOOL)a2 changeSession:(id)a3 undoTransaction:(void *)a4;
...
- (id)replaceCharactersInSelection:(id)a0 withStorage:(id)a1 usePasteRules:(BOOL)a2 srcStylesAmbiguous:(BOOL)a3 dolcContext:(id)a4 changeSession:(id)a5 undoTransaction:(void *)a6 outInsertedRanges:(id *)a7;
- (id)replaceCharactersInSelection:(id)a0 withString:(id)a1 withFlags:(unsigned int)a2 replaceTextData:(id)a3 changeSession:(id)a4 undoTransaction:(void *)a5 outInsertedRanges:(id *)a6;
...
- (void)setDropCapStyle:(id)a0 forParagraphIndexRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 undoTransaction:(void *)a2;
- (void)setLanguage:(id)a0 forCharRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 actionBuilder:(void *)a2;
- (void)setParagraphWritingDirection:(int)a0 forParagraphIndexRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a1 undoTransaction:(void *)a2;
- (id)smartFieldsWithAttributeKind:(unsigned long long)a0 inSelection:(id)a1;
...
- (id)stylesForResolvingBIUPropertiesWithSelection:(id)a0 charIndex:(unsigned long long)a1 insertionStyle:(id)a2;
...
- (id)textSourceForParagraphsContainingRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;

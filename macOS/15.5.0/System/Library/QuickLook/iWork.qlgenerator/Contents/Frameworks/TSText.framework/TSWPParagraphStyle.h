@class NSString, NSMapTable, TSSPropertySet;
...
@property (class, readonly, nonatomic) TSSPropertySet *paragraphProperties;
@property (class, readonly, nonatomic) TSSPropertySet *propertiesAllowingNSNull;
@property (class, readonly, nonatomic) TSSPropertySet *nonEmphasisParagraphProperties;
@property (class, readonly, nonatomic) TSSPropertySet *deprecatedProperties;
@property (class, readonly, nonatomic) TSSPropertySet *iWorkSpecificSimpleParagraphProperties;
...
+ (id)defaultStyleWithDefaultPropertiesInContext:(id)a0;
...
- (id)p_coreTextCharacterStyle:(id)a0 allowLigatures:(BOOL)a1 scalePercent:(unsigned long long)a2 shouldCache:(BOOL *)a3;

...
- (void)tsd_deepCopyStyledObjectInContext:(id)a0 options:(id)a1 completion:(id /* block */)a2;
- (id)tsd_deepCopyStyledObjectInContext:(id)a0 options:(id)a1 error:(id *)a2;
- (id)tsd_deepCopyStyledObjectInContext:(id)a0 options:(id)a1 objectMap:(id *)a2 error:(id *)a3;
- (id)tsd_deepCopyStyledObjectWithOptions:(id)a0;
- (void)tsd_deepCopyStyledObjectWithOptions:(id)a0 completion:(id /* block */)a1;
- (id)documentRoot;
- (BOOL)documentIsRTL;
- (id)objectLocale;
- (void)dealloc;

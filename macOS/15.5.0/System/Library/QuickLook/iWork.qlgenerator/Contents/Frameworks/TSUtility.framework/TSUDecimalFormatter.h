...
@interface TSUDecimalFormatter : NSObject {
    struct TSUDecimalFormatterCore { void /* function */ **x0; struct __CFNumberFormatter *x1; id x2; id x3; void **x4; long long x5; id x6; id x7; id x8; id x9; id x10; BOOL x11; BOOL x12; BOOL x13; } *_formatter;
}
...
- (struct _NSRange { unsigned long long x0; unsigned long long x1; })tsk_rangeOfNumericValueInString:(id)a0;
- (void)dealloc;
- (struct TSUDecimalFormatterCore { void /* function */ **x0; struct __CFNumberFormatter *x1; id x2; id x3; void **x4; long long x5; id x6; id x7; id x8; id x9; id x10; BOOL x11; BOOL x12; BOOL x13; } *)formatter;

...
@property (readonly, nonatomic) struct NSEdgeInsets { double top; double left; double bottom; double right; } paddingForEditingCell;
...
- (int)naturalAlignmentForCellID:(struct TSUCellCoord { unsigned int x0; unsigned short x1; BOOL x2; BOOL x3; })a0;

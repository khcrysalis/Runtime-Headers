@class SKPresenceOptions, NSString, NSArray, SKPresencePayload, NSMapTable, SKPresenceDaemonConnection, NSObject;
@protocol OS_dispatch_queue;

@interface SKPresence : NSObject <HMDSKPresence, SKPresenceDaemonDelegateProtocol, SKPresenceConnectionDelegateProtocol>
...
- (id)co_IDSIdentifier;
- (void)co_SetIDSIdentifier:(id)a0;
- (void)assertPresenceWithPresencePayloadDictionary:(id)a0 completion:(id /* block */)a1;
- (void).cxx_destruct;

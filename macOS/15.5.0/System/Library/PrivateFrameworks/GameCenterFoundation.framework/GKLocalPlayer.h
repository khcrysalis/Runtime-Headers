...
@property (class, nonatomic, readonly) BOOL usesGameOverlayUI;
...
+ (void)presentAccessPointInOverlayUponReturnToForeground:(BOOL)a0;
+ (void)presentAchievementBannerInOverlayWithIdentifier:(id)a0 title:(id)a1 message:(id)a2 image:(id)a3;
+ (void)presentActivitySharingRepromptInOverlayWithRecipientName:(id)a0;
+ (void)presentInGameBannerInOverlayWithData:(id)a0;
+ (void)presentOnboardingFlowInOverlayWithOrigin:(unsigned long long)a0 sceneIdentifier:(id)a1;
+ (void)presentWelcomeBannerInOverlayWithReturnToForeground:(BOOL)a0 newToGameCenter:(BOOL)a1;
+ (void)showAccessPointInOverlay;
+ (void)updateAccessPointLocationInOverlay:(long long)a0;
...
- (void)gameHasProcessedGameActivity:(id)a0;
- (void)playerWantsToPlayGameActivity:(id)a0 completion:(id /* block */)a1;
...
- (BOOL)didShowOnboardingInOverlayWithSignInOrigin:(unsigned long long)a0;
- (BOOL)didShowWelcomeBannerInOverlayWithNewUserState:(BOOL)a0 uponReturnToForeground:(BOOL)a1;
...
- (void)presentInGameBannerWithNotification:(id)a0;
...
- (void)presentBannerWithNotification:(id)a0;

...
+ (void)reportAchievements:(id)a0 withEligibleChallenges:(id)a1 withCompletionHandler:(id /* block */)a2;
...
- (void)showBanner;
- (id)challengeComposeControllerWithMessage:(id)a0 players:(id)a1 completion:(id /* block */)a2;
- (id)challengeComposeControllerWithMessage:(id)a0 players:(id)a1 completionHandler:(id /* block */)a2;
- (void)issueChallengeToPlayers:(id)a0 message:(id)a1;
- (void)selectChallengeablePlayerIDs:(id)a0 withCompletionHandler:(id /* block */)a1;
- (void)selectChallengeablePlayers:(id)a0 withCompletionHandler:(id /* block */)a1;

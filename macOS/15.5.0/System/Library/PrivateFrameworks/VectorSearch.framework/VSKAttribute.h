...
@property (class, readonly, nonatomic) VSKAttribute *mad_embeddingVersionAttribute;
@property (class, readonly, nonatomic) VSKAttribute *mad_stringIdentifierAttribute;

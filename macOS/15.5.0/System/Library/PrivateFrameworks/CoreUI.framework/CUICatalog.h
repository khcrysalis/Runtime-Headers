@class NSString, NSMapTable, NSBundle, NSDictionary, NSArray, NSCache;
...
+ (id)_IS_appearanceNameFromAppearance:(long long)a0;
+ (id)_IS_appearanceStringFromAppearance:(long long)a0;
+ (id)_IS_assetCatalogURLWithBundleURL:(id)a0;
...
- (BOOL)NS_containsVectorGlyphWithName:(id)a0;
- (id)NS_appearanceNamesForVectorGlyphWithName:(id)a0;
- (id)NS_namedVectorGlyphWithName:(id)a0;
- (id)_IS_layerStackWithName:(id)a0 scale:(double)a1 layoutDirection:(long long)a2 platform:(unsigned long long)a3;
- (id)_IS_layerStackWithName:(id)a0 scale:(double)a1 layoutDirection:(long long)a2 softCheck:(BOOL)a3 platform:(unsigned long long)a4;
- (id)_IS_multisizedImageWithName:(id)a0 size:(struct CGSize { double x0; double x1; })a1 scale:(double)a2 layoutDirection:(long long)a3 platform:(unsigned long long)a4;
- (id)_IS_multisizedImageWithName:(id)a0 size:(struct CGSize { double x0; double x1; })a1 scale:(double)a2 layoutDirection:(long long)a3 platform:(unsigned long long)a4 appearance:(long long)a5;
- (BOOL)_IS_possibleLayerStackExistsWithName:(id)a0 platform:(unsigned long long)a1;
- (BOOL)_IS_possibleMultisizedImageExistsWithName:(id)a0 platform:(unsigned long long)a1;
- (id)idiomsForPlatform:(unsigned long long)a0;
- (long long)nativeIdiom;
- (unsigned long long)subtypeForPlatform:(unsigned long long)a0;
- (void)dealloc;
- (id)debugDescription;
...
- (BOOL)hasCustomizedAppearanceForWidget:(id)a0;
- (BOOL)hasCustomizedAppearanceForWidget:(id)a0 variant:(id)a1;
...
- (id)imageWithName:(id)a0 scaleFactor:(double)a1 displayGamut:(long long)a2 layoutDirection:(long long)a3 appearanceName:(id)a4 locale:(id)a5;
...
- (id)namedVectorGlyphWithName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 layoutDirection:(long long)a3 glyphSize:(long long)a4 glyphWeight:(long long)a5 glyphPointSize:(double)a6 appearanceName:(id)a7 locale:(id)a8;
- (id)namedVectorImageWithName:(id)a0 scaleFactor:(double)a1 displayGamut:(long long)a2 layoutDirection:(long long)a3 appearanceName:(id)a4 locale:(id)a5;
...
- (id)_nameForLocalizationIdentifier:(long long)a0;
...
- (id)_namedLookupWithName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 deviceSubtype:(unsigned long long)a3 displayGamut:(long long)a4 layoutDirection:(long long)a5 sizeClassHorizontal:(long long)a6 sizeClassVertical:(long long)a7 appearanceName:(id)a8 locale:(id)a9;
...
- (id)_namedVectorImageWithName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 deviceSubtype:(unsigned long long)a3 displayGamut:(long long)a4 layoutDirection:(long long)a5 sizeClassHorizontal:(long long)a6 sizeClassVertical:(long long)a7 appearanceIdentifier:(long long)a8 locale:(id)a9;
- (id)_recognitionImageWithName:(id)a0;
- (id)_recognitionObjectWithName:(id)a0;
- (void)_resolveInterpolationSourceRenditionKeysUltralight:(id *)a0 regular:(id *)a1 black:(id *)a2 forName:(id)a3 scaleFactor:(double)a4 deviceIdiom:(long long)a5 deviceSubtype:(unsigned long long)a6 displayGamut:(long long)a7 layoutDirection:(long long)a8 sizeClassHorizontal:(long long)a9 sizeClassVertical:(long long)a10 memoryClass:(unsigned long long)a11 graphicsClass:(unsigned long long)a12 graphicsFallBackOrder:(id)a13 deviceSubtypeFallBackOrder:(id)a14 appearanceIdentifier:(long long)a15 locale:(id)a16;
- (id)_resolvedRenditionKeyForName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 deviceSubtype:(unsigned long long)a3 displayGamut:(long long)a4 layoutDirection:(long long)a5 sizeClassHorizontal:(long long)a6 sizeClassVertical:(long long)a7 memoryClass:(unsigned long long)a8 graphicsClass:(unsigned long long)a9 graphicsFallBackOrder:(id)a10 deviceSubtypeFallBackOrder:(id)a11 locale:(id)a12 withBaseKeySelector:(SEL)a13 adjustRenditionKeyWithBlock:(id /* block */)a14;
- (id)_resolvedRenditionKeyFromThemeRef:(unsigned long long)a0 withBaseKey:(id)a1 scaleFactor:(double)a2 deviceIdiom:(long long)a3 deviceSubtype:(unsigned long long)a4 displayGamut:(long long)a5 layoutDirection:(long long)a6 sizeClassHorizontal:(long long)a7 sizeClassVertical:(long long)a8 memoryClass:(unsigned long long)a9 graphicsClass:(unsigned long long)a10 graphicsFallBackOrder:(id)a11 deviceSubtypeFallBackOrder:(id)a12 locale:(id)a13 adjustRenditionKeyWithBlock:(id /* block */)a14;
...
- (void)finalizeNamedVectorGlyphLookupWithResult:(id)a0 name:(id)a1 glyphContinuousSize:(double)a2 glyphContinuousWeight:(double)a3 pointSize:(double)a4;
...
- (id)imageWithName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 deviceSubtype:(unsigned long long)a3 displayGamut:(long long)a4 layoutDirection:(long long)a5 sizeClassHorizontal:(long long)a6 sizeClassVertical:(long long)a7 appearanceName:(id)a8 locale:(id)a9;
...
- (id)imageWithName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 layoutDirection:(long long)a3 locale:(id)a4 adjustRenditionKeyWithBlock:(id /* block */)a5;
...
- (id)imageWithName:(id)a0 scaleFactor:(double)a1 locale:(id)a2;
...
- (id)layoutInformationForDrawingInRect:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })a0 context:(struct CGContext { } *)a1 options:(id)a2;
- (id)localObjectCache;
- (id)lookupCache;
...
- (id)namedLookupWithName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 deviceSubtype:(unsigned long long)a3 displayGamut:(long long)a4 layoutDirection:(long long)a5 sizeClassHorizontal:(long long)a6 sizeClassVertical:(long long)a7 appearanceName:(id)a8 locale:(id)a9;
...
- (id)namedVectorGlyphWithName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 layoutDirection:(long long)a3 glyphContinuousSize:(double)a4 glyphContinuousWeight:(double)a5 glyphPointSize:(double)a6 appearanceName:(id)a7 locale:(id)a8;
...
- (id)namedVectorImageWithName:(id)a0 scaleFactor:(double)a1 deviceIdiom:(long long)a2 deviceSubtype:(unsigned long long)a3 displayGamut:(long long)a4 layoutDirection:(long long)a5 sizeClassHorizontal:(long long)a6 sizeClassVertical:(long long)a7 appearanceName:(id)a8 locale:(id)a9;

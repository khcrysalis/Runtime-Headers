@class NSMutableDictionary, WKUserContentController, NSObject, NSDictionary, WBProfile, NSMutableArray, WBSCoreAnalyticsExtensionsStatistics, NSString, NSSet, WKWebsiteDataStore, NSTimer, NSMutableSet, NSPointerArray, NSArray, _EXQueryController, WBSExtensionsAnalyticsEventCoalescer, WBSDiagnosticStateCollector;
...
- (void)authorizeTemporaryExtensionWithCompletionHandler:(id /* block */)a0;
...
- (void)safari_disableUnpackedExtensionsIfNecessary;

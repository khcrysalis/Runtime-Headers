...
@property (readonly, nonatomic) NSImage *untintedPlatformImage;
...
+ (id)applicationIconImageForBundleIdentifier:(id)a0 length:(double)a1 scale:(double)a2;
+ (void)applicationIconImageForBundleIdentifier:(id)a0 length:(double)a1 scale:(double)a2 completionHandler:(id /* block */)a3;
+ (id)applicationIconImageForCalendarDate:(id)a0 descriptor:(id)a1;
...
+ (id)glyphNamed:(id)a0 pointSize:(double)a1 symbolWeight:(long long)a2 scaleFactor:(double)a3;
...
- (id)roundedWithContinuousCornerRadius:(double)a0 size:(struct CGSize { double x0; double x1; })a1;

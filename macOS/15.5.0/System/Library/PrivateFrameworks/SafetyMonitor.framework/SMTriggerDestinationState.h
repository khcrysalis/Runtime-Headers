@class NSString, NSUUID, NSDate, SMUpperBoundEta, CLLocation;

@interface SMTriggerDestinationState : NSObject <RTCoreDataReadable, RTCoreDataWritable, NSSecureCoding, NSCopying>
...
+ (id)createWithSMTriggerDestinationStateMO:(id)a0;

@class SMHandle, NSString, NSUUID, SMConversation, NSDate, SMSessionDestination, SMSessionTime;

@interface SMSessionConfiguration : NSObject <RTCoreDataReadable, RTCoreDataWritable, NSCopying, NSSecureCoding>
...
+ (id)createWithSMSessionConfigurationMO:(id)a0;

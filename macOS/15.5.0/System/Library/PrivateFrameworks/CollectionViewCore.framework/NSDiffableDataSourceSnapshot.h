...
- (id)appKitImpl;
- (id)mui_validItemIDFromExistingItemID:(id)a0 updateReason:(id)a1;
- (id)mui_validItemIDsFromExistingItemIDs:(id)a0 section:(id)a1 updateReason:(id)a2;
- (id)mui_validItemIDsFromExistingItemIDs:(id)a0 updateReason:(id)a1;

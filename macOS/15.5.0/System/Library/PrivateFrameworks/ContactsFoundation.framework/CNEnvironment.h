@class NSDistributedNotificationCenter, NSString, CRRecentContactsLibrary, NSNumber, CNUserDefaults, NSLocale, CNEnvironmentBase, NSNotificationCenter;
...
@property (readonly) id<CNCDIOSLegacyIdentifierRegistration> legacyIdentifierRegistrar;
@property (readonly) id<CNOpenDirectoryFacade> openDirectory;
...
@property (readonly) id<CNMetricsReporter> metricsReporter;

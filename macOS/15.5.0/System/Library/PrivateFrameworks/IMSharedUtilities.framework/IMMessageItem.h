@class NSData, NSString, NSArray, NSAttributedString, NSDate, NSDictionary, TUConversationActivity, NSIndexSet;
...
@property (nonatomic, getter=isSatelliteMessageRetry) BOOL satelliteMessageRetry;
...
+ (BOOL)isLoginAddress:(id)a0;
+ (id)bestAccountForAddress:(id)a0;
+ (Class)contextClass;
+ (id)displayNameForAddress:(id)a0;
+ (id)handleForAddress:(id)a0;
+ (BOOL)isCancelTypingMessage:(unsigned long long)a0 isEditedMessage:(BOOL)a1;
+ (BOOL)isIncomingTypingMessage:(unsigned long long)a0;
+ (BOOL)isIncomingTypingOrCancelTypingMessage:(unsigned long long)a0 isEditedMessage:(BOOL)a1;
+ (BOOL)isTypingOrCancelTypingMessage:(unsigned long long)a0 isEditedMessage:(BOOL)a1;
...
+ (id)editedMessageItemWithOriginalMessageItem:(id)a0 retractedPartIndexes:(id)a1 shouldRetractSubject:(BOOL)a2;
+ (BOOL)messageContainsSurfDD:(id)a0;
+ (unsigned long long)messagePartIndexForAttachmentMessagePartWithTransferGUID:(id)a0 inBody:(id)a1;
...
- (id)_originalService;
- (id)descriptionForPurpose:(long long)a0 isGroupMessage:(BOOL)a1 messageDataSource:(id /* block */)a2 attachmentDataSource:(id /* block */)a3;
- (id)descriptionForPurpose:(long long)a0 isGroupMessage:(BOOL)a1 senderDisplayName:(id)a2 messageDataSource:(id /* block */)a3 attachmentDataSource:(id /* block */)a4;
- (BOOL)isCancelTypingMessage;
- (BOOL)isExtensibleMessageWithPluginPayload:(id *)a0;
- (BOOL)isExtensibleMessageWithPluginPayload:(id *)a0 chatContext:(id)a1;
...
- (BOOL)_updateFileTransfersArrayReplacingTemporaryFileTransferGUIDs:(id)a0;
- (void)_updateFlags:(unsigned long long)a0;
- (BOOL)_updateMessageBodyReplacingTemporaryFileTransferGUIDsWithUpdatedGUIDs:(id)a0;
- (BOOL)_updateMessageEditHistoryReplacingTemporaryFileTransferGUIDsWithUpdatedGUIDs:(id)a0;
...
- (id)findTransferGUIDMatchingSpotlightDonatedSpeculativeTransferGUID:(id)a0;
...
- (void)setCriticalMessagingAppName:(id)a0;

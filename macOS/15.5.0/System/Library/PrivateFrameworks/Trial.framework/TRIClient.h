...
+ (id)mlr_clientWithMLRTask:(id)a0;
+ (id)mlr_namespaceNameWithMLRTask:(id)a0;
+ (id)_cachedLevelForFactor:(id)a0 withNamespaceName:(id)a1 withLanguage:(id)a2 withCache:(id)a3;
+ (void)UAFCacheUpdate;
+ (void)_addFactorLevelsToCache:(id)a0 namespaceName:(id)a1 withFactorLevelsCache:(id)a2 withLevelCache:(id)a3;
+ (void)_addLevelToCache:(id)a0 namespaceName:(id)a1 factorName:(id)a2 withCache:(id)a3;
+ (id)_cachedLevelForFactorAnyLanguage:(id)a0 withNamespaceName:(id)a1 withCache:(id)a2;
+ (id)_factoryFactorLevelsWithNamespaceName:(id)a0 onDemandClient:(id)a1;
+ (id)_factoryLevelForFactor:(id)a0 withNamespaceName:(id)a1 withLanguage:(id)a2;
+ (id)_levelKeyForCache:(id)a0 withFactorName:(id)a1 withLanguage:(id)a2;
+ (id)_queryAssetsWithNamespaceName:(id)a0 factorName:(id)a1 language:(id)a2 isRoot:(BOOL)a3 withError:(id *)a4;
+ (id)_rootFactorLevelsWithNamespaceName:(id)a0;
+ (id)_rootLevelForFactor:(id)a0 withNamespaceName:(id)a1 withLanguage:(id)a2;
...
+ (id)printedExperimentInformationWithEnvironments:(id)a0 error:(id *)a1;
...
- (id)UAFFactorLevelsWithNamespaceName:(id)a0;
- (id)UAFLevelForFactor:(id)a0 withNamespaceName:(id)a1 withLanguage:(id)a2;
- (void)_initOnce;
- (id)_trialLevelForFactor:(id)a0 withNamespaceName:(id)a1 withLanguage:(id)a2;
- (void)dealloc;
- (void).cxx_destruct;
- (void)dispose;
- (void)refresh;

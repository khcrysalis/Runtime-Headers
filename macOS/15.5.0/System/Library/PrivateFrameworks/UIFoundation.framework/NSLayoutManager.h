@class NSGlyphGenerator, NSTextStorage, NSTextContainer, NSSortedArray, NSMutableArray, NSBox, NSStorage, NSFont, CUIStyleEffectConfiguration, NSTypesetter, NSParagraphArbitrator, NSRunStorage, NSTabWell, NSArray, NSTextView;
...
@property (weak) id<NSLayoutManagerDelegate> delegate;
...
@property (readonly) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } extraLineFragmentRect;
@property (readonly) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } extraLineFragmentUsedRect;
...
- (BOOL)layoutManagerOwnsFirstResponderInWindow:(id)a0;
...
- (void)showPackedGlyphs:(char *)a0 length:(unsigned long long)a1 glyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a2 atPoint:(struct CGPoint { double x0; double x1; })a3 font:(id)a4 color:(id)a5 printingAdjustment:(struct CGSize { double x0; double x1; })a6;
...
- (unsigned int)glyphAtIndex:(unsigned long long)a0 isValidIndex:(BOOL *)a1;
...
- (void)_drawGlyphsForGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 atPoint:(struct CGPoint { double x0; double x1; })a1 parameters:(struct _NSDrawingParameters { id x0; id x1; } *)a2;
...
- (double)_rotationForGlyphAtIndex:(unsigned long long)a0 effectiveRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; } *)a1;
- (id)_rowArrayCache;
...
- (void)_setRotation:(double)a0 forGlyphAtIndex:(unsigned long long)a1;
...
- (void)_swizzledShowCGGlyphs:(const unsigned short *)a0 positions:(const struct CGPoint { double x0; double x1; } *)a1 count:(long long)a2 font:(id)a3 matrix:(struct CGAffineTransform { double x0; double x1; double x2; double x3; double x4; double x5; })a4 attributes:(id)a5 inContext:(struct CGContext { } *)a6;
...
- (unsigned int)glyphAtIndex:(unsigned long long)a0;
- (id)glyphGenerator;
...
- (id)linkAttributesForAttributes:(id)a0 forCharacterAtIndex:(unsigned long long)a1;
...
- (void)showCGGlyphs:(const unsigned short *)a0 positions:(const struct CGPoint { double x0; double x1; } *)a1 count:(unsigned long long)a2 font:(id)a3 matrix:(id)a4 attributes:(id)a5 inContext:(id)a6;

...
- (void)renderSquareThumbnailsForStyles:(id)a0 scaledToFill:(struct CGSize { double x0; double x1; })a1 completionHandler:(id /* block */)a2;
- (void)renderSquareThumbnailsFor:(id)a0 scaledToFill:(struct CGSize { double x0; double x1; })a1 reusingRenderContext:(id)a2 completionHandler:(id /* block */)a3;
...
- (id)cinematicAudioAdjustmentControllerCreatingIfNecessary:(BOOL)a0;
...
- (id)inpaintAdjustmentControllerCreatingIfNecessary:(BOOL)a0;
...
- (id)semanticStyleAdjustmentControllerCreatingIfNecessary:(BOOL)a0;

@class HMIVideoAnalyzerConfiguration, NSString, NSUUID, NSSet, HMIVideoAnalyzerState, HMIHomePersonManager, NSDictionary, HMIAnalysisStateManager, HMIVideoAnalyzerMutableReport;
@protocol HMDCameraRecordingSessionVideoAnalyzerDelegate, HMIVideoAnalyzerDelegate;

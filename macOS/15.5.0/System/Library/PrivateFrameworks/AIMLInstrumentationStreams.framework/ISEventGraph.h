...
@interface ISEventGraph : NSObject {
    ...
    void /* unknown type, empty encoding */ $__lazy_storage_$_finalTrpId;
    void /* unknown type, empty encoding */ $__lazy_storage_$_rootTrpId;
    void /* unknown type, empty encoding */ $__lazy_storage_$_selfIds;
    void /* unknown type, empty encoding */ $__lazy_storage_$_requests;
}

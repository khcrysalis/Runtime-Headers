@class SFColor, NSString, NSData, NSArray, SFCard, SFUserReportRequest, NSDictionary, SFCommand, SFAppEntityAnnotation, NSMutableDictionary, SFSearchResult_SpotlightExtras;
...
- (void)addCardsFromEmbeddedSectionsTo:(id)a0;
- (void)addCardsFromButtonsTo:(id)a0;
- (void)addCardsFromCommandsTo:(id)a0;
- (BOOL)hasCanBeHidden;

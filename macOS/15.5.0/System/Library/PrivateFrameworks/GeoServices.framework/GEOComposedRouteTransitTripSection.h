...
- (BOOL)_getEndPoints:(id)a0 rect:(const void *)a1 result:(void *)a2;
- (BOOL)_validateSnappedPaths:(id)a0 snappedTileBounds:(const void *)a1 overlay:(id)a2;
- (id)pathsForRenderRegion:(id)a0 inOverlay:(id)a1 shouldSnapToTransit:(BOOL)a2 verifySnapping:(BOOL)a3;
- (id)unsnappedPathsInOverlay:(id)a0;
- (id).cxx_construct;

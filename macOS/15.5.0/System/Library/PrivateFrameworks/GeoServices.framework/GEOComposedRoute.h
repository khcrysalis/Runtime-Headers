...
@property (readonly, nonatomic) BOOL routeRequiresElevationCorrection;
...
+ (void)_addPointsToArray:(id)a0 forMapPoints:(struct { double x0; double x1; } *)a1 pointCount:(unsigned long long)a2 isPolylineA:(BOOL)a3;
+ (void)_findDivergenceAndConvergence:(struct { double x0; double x1; } *)a0 pointCount:(unsigned long long)a1 otherPoints:(struct { double x0; double x1; } *)a2 pointCount:(unsigned long long)a3 divergenceTolerance:(double)a4 convergenceTolerance:(double)a5 outDivergenceCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a6 outDivergenceCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a7 outConvergenceCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a8 outConvergenceCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a9;
+ (BOOL)_pointsConverge:(struct { double x0; double x1; } *)a0 pointCount:(unsigned long long)a1 otherPoints:(struct { double x0; double x1; } *)a2 pointCount:(unsigned long long)a3 tolerance:(double)a4 outCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a5 outCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a6;
+ (BOOL)_pointsConverge:(struct { double x0; double x1; } *)a0 pointCount:(unsigned long long)a1 otherPoints:(struct { double x0; double x1; } *)a2 pointCount:(unsigned long long)a3 tolerance:(double)a4 outCoordinatesA:(out id *)a5 outCoordinatesB:(out id *)a6;
+ (BOOL)_pointsDiverge:(struct { double x0; double x1; } *)a0 pointCount:(unsigned long long)a1 otherPoints:(struct { double x0; double x1; } *)a2 pointCount:(unsigned long long)a3 tolerance:(double)a4 outCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a5 outCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a6;
+ (unsigned long long)_startIndexForPoints:(struct Matrix<double, 2, 1> { double x0[2]; })a0 withPoints:(void *)a1 pointCount:(unsigned long long)a2 toleranceSquared:(double)a3;
+ (id)_stringForPoint:(const void *)a0;
+ (void)findDivergenceAndConvergence:(struct { double x0; double x1; } *)a0 pointCount:(unsigned long long)a1 otherCoordinates:(struct { double x0; double x1; } *)a2 pointCount:(unsigned long long)a3 distanceInMeters:(double)a4 outDivergenceCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a5 outDivergenceCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a6 outConvergenceCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a7 outConvergenceCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a8;
+ (void)findDivergenceAndConvergence:(struct { double x0; double x1; } *)a0 pointCount:(unsigned long long)a1 otherPoints:(struct { double x0; double x1; } *)a2 pointCount:(unsigned long long)a3 divergenceTolerance:(double)a4 convergenceTolerance:(double)a5 outCoordinatesA:(out id *)a6 outCoordinatesB:(out id *)a7;
+ (void)findDivergenceAndConvergence:(struct { double x0; double x1; } *)a0 pointCount:(unsigned long long)a1 otherPoints:(struct { double x0; double x1; } *)a2 pointCount:(unsigned long long)a3 outDivergenceCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a4 outDivergenceCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a5 outConvergenceCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a6 outConvergenceCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a7;
+ (BOOL)pointsConverge:(struct { double x0; double x1; } *)a0 pointCount:(unsigned long long)a1 otherPoints:(struct { double x0; double x1; } *)a2 pointCount:(unsigned long long)a3 outCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a4 outCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a5;
+ (BOOL)pointsDiverge:(struct { double x0; double x1; } *)a0 pointCount:(unsigned long long)a1 otherPoints:(struct { double x0; double x1; } *)a2 pointCount:(unsigned long long)a3 outCoordinateA:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a4 outCoordinateB:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a5;

- (id)_navigation_rootBoundingSection;
- (id)_mapPoints;
- (id)_navigation_allLeafBoundingSections;
- (id)_navigation_boundingSectionForRange:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x0; float x1; } x0; struct PolylineCoordinate { unsigned int x0; float x1; } x1; })a0 leafIndex:(unsigned long long *)a1;
- (id)_navigation_leafBoundingSectionContainingCoordinate:(struct { double x0; double x1; double x2; })a0;
- (id)_navigation_leafBoundingSectionForRouteCoordinate:(struct PolylineCoordinate { unsigned int x0; float x1; })a0;
- (id)_navigation_leafBoundingSectionsIntersectingSection:(id)a0;
- (id)_navigation_leafBoundingSectionsIntersectingSection:(id)a0 paddingMapPoints:(double)a1;
- (id)divergenceAndConvergenceWithRoute:(id)a0;
- (id)divergenceAndConvergenceWithRoute:(id)a0 outOtherRoutePoints:(out id *)a1;
- (void)findDivergenceAndConvergenceWithRoute:(id)a0 distanceInMeters:(double)a1 outDivergenceCoordinate:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a2 outConvergenceCoordinate:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a3;
- (void)findDivergenceAndConvergenceWithRoute:(id)a0 outDivergenceCoordinate:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a1 outConvergenceCoordinate:(out struct PolylineCoordinate { unsigned int x0; float x1; } *)a2;
- (BOOL)isMultipointRoute;
- (BOOL)isNavigableForWatch;
- (id)userRequestedWaypoints;
- (void)_applyAltitudeCorrectionIfNecessary:(struct { double x0; double x1; double x2; } *)a0;
- (struct { double x0; double x1; double x2; })pointWithAltitudeCorrectionAtIndex:(unsigned long long)a0;
- (struct { double x0; double x1; double x2; })pointWithAltitudeCorrectionAtRouteCoordinate:(struct PolylineCoordinate { unsigned int x0; float x1; })a0;
- (BOOL)shouldRequestWGS84Elevations;
- (void)dealloc;
- (id)init;
- (void).cxx_destruct;

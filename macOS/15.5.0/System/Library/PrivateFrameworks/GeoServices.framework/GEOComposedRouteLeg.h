@class NSData, NSString, NSArray, GEOComposedRoute, GEOArrivalParameters, GEOComposedWaypoint, GEOWaypointInfo, GEOComposedString, GEOComposedRouteEVChargingStationInfo, GEOComposedWaypointDisplayInfo;
...
- (id)waypointSubstitutedComposedStringForString:(id)a0 waypoint:(id)a1 useWaypointAddress:(BOOL)a2;
- (id)description;
- (void).cxx_destruct;

...
+ (id)locationWithCLLocation:(id)a0 course:(double)a1;
+ (BOOL)isValid:(id)a0;

- (id)_initWithCLClientLocation:(const struct { int x0; struct { double x0; double x1; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; int x10; double x11; int x12; struct { double x0; double x1; } x13; double x14; int x15; unsigned int x16; int x17; int x18; int x19; double x20; BOOL x21; } *)a0;
- (struct { int x0; struct { double x0; double x1; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; int x10; double x11; int x12; struct { double x0; double x1; } x13; double x14; int x15; unsigned int x16; int x17; int x18; int x19; double x20; BOOL x21; })clientLocation;
- (id)initWithCLLocation:(id)a0;
- (id)initWithCLLocation:(id)a0 course:(double)a1;
- (id)initWithCLLocation:(id)a0 useMatchInfo:(BOOL)a1;

@class GEOMapItemDetourInfo, GEOMapItemPhotosAttribution, GEOPDResultDetourInfo, GEORestaurantFeaturesLink, NSNumber, GEOMapItemClientAttributes, GEOTrailHead, GEOMuninViewState, GEOBusinessAssets, geo_isolater, GEOMessageLink, GEOMapItemContainedPlace, GEOPlacecardLayoutData, GEOPDPlace, GEOPDHikeAssociatedInfo, NSMutableArray, GEOStyleAttributes, GEOMapItemIdentifier, NSSet, GEOEnrichmentInfo, GEOMiniBrowseCategories, GEOViewportFrame, GEOExploreGuides, GEOLabelGeometry, GEOAppleRating, GEOPDFlyover, GEOEnrichmentData, NSData, GEOPlaceResult, GEOEnhancedPlacement, GEOMapItemStorageUserValues, NSDate, GEOAssociatedApp, GEOLatLng, NSArray, PBUnknownFields, GEOPOIClaim, NSTimeZone, GEOFeatureStyleAttributes, GEOMapItemPlaceAttribution, GEOPDURLData, GEOPriceDescription, GEOInlineRapEnablement, PBDataReader, _GEOMapItemStorageNotificationTrampoline, GEOTooltip, GEOAddress, NSString, GEOStorefrontInfo, GEOEVCharger, GEOPDHikeGeometry, NSURL, GEOLocalizedString, NSDictionary, GEOHikeSummary, GEOPlaceQuestionnaire, GEOEnclosingPlace, GEOMapRegion, GEOMapItemReviewsAttribution, GEOStorefrontPresentationInfo, GEOPlace;
...
+ (id)mapItemStorageForGEOMapItem:(id)a0 locationOfInterestType:(long long)a1;
+ (id)mapItemStorageForPlace:(id)a0 locationOfInterestType:(long long)a1;

...
@property (nonatomic) BOOL isGenerated;
...
+ (unsigned long long)_baseMCTForEvent:(id)a0;
...
- (void)_checkForFormatStringFlags:(id)a0 shouldCompose:(BOOL)a1;
- (void)_handleSignpostDescriptionPlaceholder:(id)a0;
- (void)_handleSignpostTelemetryPlaceholder:(id)a0;
- (void)_parseMetadataSegments:(BOOL)a0;
- (id)initWithOSLogEventProxy:(id)a0 timebaseRatio:(double)a1 shouldCompose:(BOOL)a2;
- (id)copy;
- (BOOL)isEqual:(id)a0;
- (void).cxx_destruct;
...
- (id)_argumentObjectWithPrefix:(id)a0;
- (id)_argumentObjectWithPrefix:(id)a0 expectedClass:(Class)a1;
- (id)_dataArgumentWithName:(id)a0;
- (id)_dataArgumentWithPrefix:(id)a0;
...
- (id)_numberArgumentWithPrefix:(id)a0;
- (unsigned long long)_resolvedBeginTime;
- (unsigned long long)_resolvedEndTime;
- (id)_stringArgumentWithName:(id)a0;
- (id)_stringArgumentWithPrefix:(id)a0;
- (id)copyWithType:(unsigned long long)a0 machContinuousTime:(unsigned long long)a1;
...
- (id)oppositeEventForIntervalWithDeltaSeconds:(double)a0;

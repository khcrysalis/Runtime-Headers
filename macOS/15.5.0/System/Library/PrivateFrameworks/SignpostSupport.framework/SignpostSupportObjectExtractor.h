...
+ (BOOL)getDataSourceDateRange:(id)a0 earliestDateOut:(id *)a1 latestDateOut:(id *)a2 errorsOut:(id *)a3;
+ (id)_eventSourceForPath:(id)a0 errorOut:(id *)a1;
+ (BOOL)dateRangeOfLogArchiveWithPath:(id)a0 startDateOut:(id *)a1 endDateOut:(id *)a2 errorOut:(id *)a3;

- (BOOL)_processLogEventStream:(id)a0 startDate:(id)a1 endDate:(id)a2 errorOut:(id *)a3;
- (void)_processOSLogEventProxy:(id)a0;
- (void)_processStreamedOSLogEventProxy:(id)a0 shouldCalculateFramerate:(BOOL)a1;
- (BOOL)_processTraceFileWithPath:(id)a0 startDate:(id)a1 endDate:(id)a2 errorOut:(id *)a3;
- (BOOL)_processTraceUsingKtraceLoggingDataSource:(id)a0 startDate:(id)a1 endDate:(id)a2 errorOut:(id *)a3;
- (BOOL)processFileWithPath:(id)a0 startDate:(id)a1 endDate:(id)a2 errorsOut:(id *)a3;
- (BOOL)processLogArchiveWithPath:(id)a0 startDate:(id)a1 endDate:(id)a2 errorOut:(id *)a3;
- (BOOL)processNotificationsWithIntervalTimeoutInSeconds:(unsigned long long)a0 errorOut:(id *)a1;
- (BOOL)processNotificationsWithIntervalTimeoutInSeconds:(unsigned long long)a0 shouldCalculateAnimationFramerate:(BOOL)a1 targetQueue:(id)a2 errorOut:(id *)a3;
- (BOOL)processTraceFileWithPath:(id)a0 errorOut:(id *)a1;
- (BOOL)processTraceFileWithPath:(id)a0 startDate:(id)a1 endDate:(id)a2 errorOut:(id *)a3;
- (void)dealloc;
- (id)init;
- (void).cxx_destruct;

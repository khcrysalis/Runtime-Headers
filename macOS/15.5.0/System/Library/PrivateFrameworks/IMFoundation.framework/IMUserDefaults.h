...
@property (class, readonly, nonatomic) NSString *keyTransparencyAccountKeyFetchMetricDeviceID;
@property (class, retain, nonatomic) NSNumber *ftMessageDeliveryServerTimestamp;
@property (class, retain, nonatomic) NSNumber *ftMessageDeliveryServerTimestampReceivedDate;
...
@property (class, readonly, nonatomic) BOOL isWriteBlastDoorPayloadsToDiskEnabled;
@property (class, readonly, nonatomic) NSString *writePushPayloadsToDiskPath;
@property (class, readonly, nonatomic) BOOL shouldDisableFailFastWhenSatelliteIsAvailable;
...
- (void)setClearStateOnLaunch:(BOOL)a0;

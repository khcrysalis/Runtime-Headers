@class NSString, NSArray, NSURL, NSAttributedString, NSSet, WebBookmark, NSDictionary, WBTab, NSMutableArray, NSMutableDictionary, WBSCopyOnWriteValue, WBSCRDTPosition;

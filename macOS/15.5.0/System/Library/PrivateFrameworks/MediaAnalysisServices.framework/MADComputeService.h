...
- (id)performRequests:(id)a0 assets:(id)a1 photoLibrary:(id)a2 options:(id)a3 progressHandler:(id /* block */)a4 resultsHandler:(id /* block */)a5 completionHandler:(id /* block */)a6;
- (id)scheduleRequests:(id)a0 assets:(id)a1 photoLibrary:(id)a2 options:(id)a3 error:(id *)a4;
- (void)dealloc;
- (id)init;
- (void).cxx_destruct;
- (id)connection;

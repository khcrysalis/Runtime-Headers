...
@property (readonly, nonatomic) BOOL ql_hasDolbyVisionContent;
...
- (id)plVideoCodecName;
- (id)vcp_enabledTracksWithMediaType:(id)a0;
- (id)vcp_assetWithoutAdjustments:(id)a0 duration:(double)a1;
- (id)vcp_firstEnabledTrackWithMediaType:(id)a0;
- (struct __CVBuffer { } *)vcp_frameAtTimeStamp:(struct { long long x0; int x1; unsigned int x2; long long x3; })a0 withMaxDimension:(unsigned long long)a1;
- (BOOL)vcp_isMontage;
- (BOOL)vcp_isShortMovie;
- (struct __CVBuffer { } *)vcp_keyFrameWithMaxDimension:(unsigned long long)a0;
- (struct { long long x0; int x1; unsigned int x2; long long x3; })vcp_livePhotoStillDisplayTime;
- (void)vcp_scaleRampWithIntervals:(id)a0 andRates:(id)a1 inSlowmoTimerange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a2 withTimeMapping:(id)a3 inComposition:(id)a4;
- (void)vcp_scaleSlowmoTimeRange:(struct { struct { long long x0; int x1; unsigned int x2; long long x3; } x0; struct { long long x0; int x1; unsigned int x2; long long x3; } x1; })a0 withTimeMapping:(id)a1 inComposition:(id)a2;
- (void)dealloc;

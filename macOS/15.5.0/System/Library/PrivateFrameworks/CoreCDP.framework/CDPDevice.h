@class OTEscrowRecord, NSString, NSDictionary, NSData, NSDate, NSNumber;
...
- (id)initWithEscrowRecord:(id)a0;
- (id)initWithSecureBackupRecordInfo:(id)a0;
- (id)initWithEscrowRecordMetadata:(id)a0;
- (id)initWithSecureBackupMetadataInfo:(id)a0;

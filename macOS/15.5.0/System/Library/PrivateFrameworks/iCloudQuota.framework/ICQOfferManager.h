...
- (void)setFlowManager:(id)a0;
- (void)_getCachedLinkData:(id)a0 completion:(id /* block */)a1;
- (void)fetchAndPresentUpsellForBundleIdentifier:(id)a0 event:(id)a1 completion:(id /* block */)a2;
- (id)flowManager;

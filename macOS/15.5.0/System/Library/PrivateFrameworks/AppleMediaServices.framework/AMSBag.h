@class AMSBagUnderlyingData, AMSProcessInfo, NSString, NSDate, AMSBagCachedValueUpdateHandlers, AMSBagCache, NSObject, AMSBagUnderlyingDataPersistence;
@protocol AMSBagProtocol, OS_dispatch_queue, AMSBagDataSourceProtocol;

@interface AMSBag : NSObject <AMSBagProtocol>

@property (class, readonly) id<AMSBagProtocol> amsui_internalBag;
@property (class, readonly, nonatomic) AMSBag *quotaBag;

...
+ (long long)phImageRequestOptionsDegradedImagesToReturnFromPXImageRequestOptionsDegradedImagesToReturn:(long long)a0;
+ (long long)phImageRequestOptionsDeliveryModeFromPXImageRequestOptionsDeliveryMode:(long long)a0;
+ (long long)phImageRequestOptionsResizeModeFromPXImageRequestOptionsResizeMode:(long long)a0;
+ (long long)phImageRequestOptionsVersionFromPXImageRequestOptionsVersion:(long long)a0;
+ (long long)pxImageRequestOptionsDegradedImagesToReturnFromPHImageRequestOptionsDegradedImagesToReturn:(long long)a0;
+ (long long)pxImageRequestOptionsDeliveryModeFromPHImageRequestOptionsDeliveryMode:(long long)a0;
+ (long long)pxImageRequestOptionsResizeModeFromPHImageRequestOptionsResizeMode:(long long)a0;
+ (long long)pxImageRequestOptionsVersionFromPHImageRequestOptionsVersion:(long long)a0;

- (void)copyPropertiesFromPhotoKitOptions:(id)a0;
- (void)copyPropertiesToPhotoKitOptions:(id)a0;
- (id)initWithUnderlyingPhotoKitImageRequestOptions:(id)a0;
- (id)photoKitRequestOptions;
- (void)setUnderlyingPhotoKitImageRequestOptions:(id)a0;

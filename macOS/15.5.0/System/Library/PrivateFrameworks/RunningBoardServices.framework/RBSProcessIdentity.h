...
@interface RBSProcessIdentity : NSObject <FBSSceneClientIdentifying, RBSProcessMatching, RBSXPCSecureCoding, NSSecureCoding, NSCopying> {
    int _pid;
}
...
@property (readonly, nonatomic) BOOL isMultiInstanceExtension;
...
+ (id)identityForLSApplicationIdentity:(id)a0 LSApplicationRecord:(id)a1 uuid:(id)a2;
+ (id)identityForUnbundledMacApplicationJobLabel:(id)a0;
+ (id)identityForPlugInKitIdentifier:(id)a0;
+ (id)identityForApplicationJobLabel:(id)a0;
+ (id)identityForWrappedInfoProvider:(id)a0;
+ (id)_identityForXPCServiceIdentifier:(id)a0 variant:(long long)a1;
+ (id)decodeFromJob:(id)a0 uuid:(id)a1;
...
+ (id)identityForAppViewServiceIdentifier:(id)a0;
...
+ (id)identityForWrappedInfoProvider:(id)a0 uuid:(id)a1;

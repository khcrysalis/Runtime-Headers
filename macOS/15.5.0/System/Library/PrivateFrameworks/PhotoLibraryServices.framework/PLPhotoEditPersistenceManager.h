...
+ (id)compositionControllerWithAdjustmentData:(id)a0 asset:(id)a1 imageOrientation:(long long)a2 outMasterWidth:(long long *)a3 outMasterHeight:(long long *)a4;
...
- (id)loadCompositionFrom:(id)a0 formatIdentifier:(id)a1 formatVersion:(id)a2 sidecarData:(id)a3 error:(id *)a4;

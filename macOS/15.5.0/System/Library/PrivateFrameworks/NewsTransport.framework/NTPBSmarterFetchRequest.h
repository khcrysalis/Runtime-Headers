...
- (id)initWithUserInfo:(id)a0 personalizationParams:(id)a1 tagsFollowed:(id)a2 mutedTagIDs:(id)a3 fetchRecordSpecs:(id)a4 fetchSource:(id)a5 fetchStrategy:(id)a6 fromDate:(id)a7 toDate:(id)a8;

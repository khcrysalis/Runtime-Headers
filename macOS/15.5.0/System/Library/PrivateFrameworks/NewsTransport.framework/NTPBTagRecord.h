...
@property (nonatomic) BOOL hasFoodGroupingAvailability;
...
- (id)generateNameImageLargeAssetHandleForURLString:(id)a0 withAssetManager:(id)a1;
- (id)generateCoverImageAssetHandleForURLString:(id)a0 withAssetManager:(id)a1;
- (id)generateCoverImageAssetHandleWithAssetManager:(id)a0;
- (id)generateFeedNavImageAssetHandleWithAssetManager:(id)a0;
- (id)generateFeedNavImageHQAssetHandleWithAssetManager:(id)a0;
- (id)generateLogoImageAssetHandleWithAssetManager:(id)a0;
- (id)generateNameImageAssetHandleWithAssetManager:(id)a0;
- (id)generateNameImageCompactAssetHandleWithAssetManager:(id)a0;
- (id)generateNameImageForDarkBackgroundAssetHandleWithAssetManager:(id)a0;
- (id)generateNameImageLargeMaskAssetHandleForURLString:(id)a0 withAssetManager:(id)a1;
- (id)generateNameImageMaskAssetHandleForURL:(id)a0 withAssetManager:(id)a1;
- (id)generateNavigationChromeBackgroundImageAssetHandleForURLString:(id)a0 withAssetManager:(id)a1;
- (id)generateNavigationChromeBackgroundImageCompactAssetHandleForURLString:(id)a0 withAssetManager:(id)a1;
- (id)generateNavigationChromeBackgroundImageLargeAssetHandleForURLString:(id)a0 withAssetManager:(id)a1;
- (id)generateSportsLogoAltImageAssetHandleWithAssetManager:(id)a0;
- (id)generateSportsLogoAltImageCompactAssetHandleWithAssetManager:(id)a0;
- (id)generateSportsLogoAltImageLargeAssetHandleWithAssetManager:(id)a0;
- (id)generateSportsLogoImageAssetHandleWithAssetManager:(id)a0;
- (id)generateSportsLogoImageCompactAssetHandleWithAssetManager:(id)a0;
- (id)generateSportsLogoImageLargeAssetHandleWithAssetManager:(id)a0;
- (void)dealloc;

...
- (id)contentManifest;
- (BOOL)fc_isNewerThan:(id)a0;
- (BOOL)fc_isCachedAgeGreaterThan:(double)a0;
- (BOOL)fc_isCachedAgeLessThan:(double)a0;
- (id)generateThumbnailAssetHandleForURL:(id)a0 withAssetManager:(id)a1;
- (void)dealloc;

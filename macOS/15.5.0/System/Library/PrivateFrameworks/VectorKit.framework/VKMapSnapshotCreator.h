...
- (void)_mapkit_configureWithOptions:(id)a0 configuration:(struct { long long x0; long long x1; long long x2; long long x3; long long x4; long long x5; BOOL x6; } *)a1 scale:(double)a2;
- (id)initWithSnapshotOptions:(id)a0 scale:(double)a1 homeQueue:(id)a2 auditToken:(id)a3;
- (void)dealloc;
- (void).cxx_destruct;
- (id).cxx_construct;
- (void)timeout;
...
- (id)initWithSize:(struct CGSize { double x0; double x1; })a0 scale:(double)a1 homeQueue:(id)a2 signpostId:(unsigned long long)a3 mapType:(int)a4 mapDisplayStyles:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; } *)a5 mapDisplayStylesCount:(unsigned long long)a6 auditToken:(id)a7 useMultisampling:(BOOL)a8 withError:(out id *)a9;
- (void)labelManagerDidLayout;
- (void)labelMarkerDidChangeState:(const void *)a0;
- (void)locationInHikingContextualRegion:(BOOL)a0;

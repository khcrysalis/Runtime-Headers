...
@interface VKMapView : CALayer {
    ...
    struct { unsigned char timePeriod; unsigned char overlayType; unsigned char applicationState; unsigned char applicationSubState; unsigned char searchResultsType; BOOL mapHasLabels; } _mapDisplayStyle;
...
@property (nonatomic) struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; } mapDisplayStyle;
...
@property (nonatomic, getter=isOfflineMode) BOOL offlineMode;
...
@property (nonatomic) BOOL showsContourLabels;
@property (nonatomic) BOOL showsPhysicalFeatureLabels;
...
@property (readonly, nonatomic) BOOL isFlyoverUnificationEnabled;
...
- (void)setMapDisplayStyle:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; })a0 animated:(BOOL)a1;
...
- (void)setShowsHiking:(BOOL)a0 withTopographicFeatures:(BOOL)a1;
...
- (void)_applyMapDisplayStyle:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; })a0 animated:(BOOL)a1 duration:(double)a2;
...
- (void)enableMapDisplayStyleDebugOverride:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; })a0;
...
- (void)mapDidFinishChangingMapDisplayStyle:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; })a0;
...
- (void)setLevelOfDetail:(unsigned char)a0 animated:(BOOL)a1;
- (void)setLoadMuninMetadata:(BOOL)a0;
- (void)setMapDisplayStyle:(struct { unsigned char x0; unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; BOOL x5; })a0 animated:(BOOL)a1 duration:(double)a2;

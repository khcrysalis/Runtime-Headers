...
@property (nonatomic) struct vImage_Buffer { void *data; unsigned long long height; unsigned long long width; unsigned long long rowBytes; } vImage;
...
- (id)imageByRectifyingRegion:(id)a0 toColorSpace:(int)a1 homography:(struct { void /* unknown type, empty encoding */ x0[3]; } *)a2;
...
- (id)initWithFloatBuffer:(float *)a0 width:(unsigned long long)a1 height:(unsigned long long)a2;

...
@interface EMMailbox : EMRepositoryObject <MSBucketBarMailbox, EMMailboxBuilder, NSSecureCoding, EFPubliclyDescribable> {
...
@property (readonly, nonatomic) BOOL isCoreSpotlightMailbox;
@property (readonly, nonatomic) BOOL isTrashMailbox;

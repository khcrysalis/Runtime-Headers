...
@interface EMContentRepresentation : NSObject <_EMDistantContentRepresentation, NSSecureCoding, EMMessageContentCachedMetadataDelegate, EFPubliclyDescribable> {
...
- (id)requestRepresentationForItemWithObjectID:(id)a0 options:(id)a1 delegate:(id)a2 completionHandler:(id /* block */)a3;
- (id)requestUpdatedRepresentationWithCompletion:(id /* block */)a0;
- (void)dealloc;
- (void).cxx_destruct;
...
- (void)requestOriginalContentMessagesInReplyToContentItemWithCompletion:(id /* block */)a0;

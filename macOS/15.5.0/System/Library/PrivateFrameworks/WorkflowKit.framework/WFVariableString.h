...
+ (id)attributedStringWithVariable:(id)a0;

- (id)substringWithRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0;
- (id)initWithAttributedString:(id)a0;
- (id)attributedStringByAddingTypingAttributes:(id)a0;
- (id)stringByReplacingCharactersInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withVariable:(id)a1;
- (id)stringByReplacingCharactersInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })a0 withVariableString:(id)a1;

...
- (BOOL)VNEnumerateFloatValuesAtIndexes:(id)a0 asTensor:(id)a1 usingBlock:(id /* block */)a2 error:(id *)a3;
- (BOOL)VNGetConfidenceValue:(float *)a0 asTensor:(id)a1 error:(id *)a2;

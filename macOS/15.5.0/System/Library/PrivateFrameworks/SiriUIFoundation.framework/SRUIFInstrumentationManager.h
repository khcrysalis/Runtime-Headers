...
- (void)emitInvocationWithSource:(int)a0 eventTime:(unsigned long long)a1;
- (id)init;
- (void).cxx_destruct;
...
- (void)processSessionEvent:(long long)a0 isSpeechSynthesisSpeaking:(BOOL)a1 machAbsoluteTime:(double)a2;
...
- (void)emitUUFRSpokenForAceObject:(id)a0 presentationType:(int)a1 dialogPhase:(id)a2 mode:(int)a3 speakableText:(id)a4 dialogIdentifierOverride:(id)a5;
- (void)emitUserBargeInEventForBargedInTurn;
- (void)emitUserBargeInEventForBargedInTurn:(id)a0 machAbsoluteTime:(double)a1;
- (void)emitVRXInstrumentationEvent:(id)a0 aceViewId:(id)a1 cardEngagementProcessed:(BOOL)a2;

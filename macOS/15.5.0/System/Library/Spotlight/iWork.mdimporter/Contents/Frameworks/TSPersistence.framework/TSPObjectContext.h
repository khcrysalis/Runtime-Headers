...
@property (readonly, nonatomic) BOOL hasMissingOrUnmaterializedRemoteData;
@property (readonly, nonatomic) BOOL hasExternalReferenceOrMissingOrUnmaterializedRemoteData;
...
- (id)documentRoot;
- (id)objectLocale;
- (void)proxyObjectMapping:(id)a0 willProxyReferencedObject:(id)a1;
- (void)dealloc;
- (id)init;
- (void).cxx_destruct;
- (void)close;
...
- (BOOL)isResourceAccessTypeFinished:(long long)a0;
...
- (BOOL)updateDocumentUUIDPreserveOriginalDocumentSupport:(BOOL)a0 preserveShareUUID:(BOOL)a1 preserveStableDocumentUUID:(BOOL)a2 error:(id *)a3;
